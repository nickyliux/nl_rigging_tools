...
COMPONENT_DICT = {
    ...
    "spineQd": {"M": "spineQd"},
    "tail": {"M": "tail"},
    "arm": {"L": "lfArmBp", "R": "rtArmBp"},
    "hand": {"L": "lfHandBp", "R": "rtHandBp"},
    "legPlanti": {"L": "lfLegBp", "R": "rtLegBp"},
    "legDigitiUnguli": {"L": "lfLegQd", "R": "rtLegQd"},
    # "leg / bird": {"L": "lfLegBird", "R": "rtLegBird"},
    "finger": {"L": "lfFingerFk", "R": "rtFingerFk"},
    "simpleFk": {"M": "mdSimpleFk", "L": "lfSimpleFk", "R": "rtSimpleFk"},
    "belt": {"M": "belt"},
}
