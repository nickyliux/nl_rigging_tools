...
class MarkingMenuRigging:
    ...
    def setupMenu(self, menu, parent):
        ...
        mc.menuItem(p=connect_MI, l="T  to  T", c=partial(connect_channel, "t"))
        mc.menuItem(p=connect_MI, l="R  to  R", c=partial(connect_channel, "r"))
        mc.menuItem(p=connect_MI, l="S  to  S", c=partial(connect_channel, "s"))
        ...
        mc.menuItem(p=joint_MI, l="Single Chain", c=partial(add_IK, Solver.SC))
        mc.menuItem(p=joint_MI, l="Rotate Plane", c=partial(add_IK, Solver.RP))
        mc.menuItem(p=joint_MI, l="Spline", c=partial(add_IK, Solver.SPLINE))
        mc.menuItem(p=joint_MI, l="Spring", c=partial(add_IK, Solver.SPRING))
        mc.menuItem(p=joint_MI, l="2B", c=partial(add_IK, Solver.TWO_BONE))
