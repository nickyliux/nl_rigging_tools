...
class MarkingMenuRigging:
    ...
    def setupMenu(self, menu, parent):
        ...
        mc.menuItem(p=mi, l="Joint", c="mc.select(cl=1);mc.joint()", ob=1)

        mi = mc.menuItem(p=menu, l="Show", rp="NW", subMenu=1)
        mc.menuItem(p=mi, l="All", c=showAll)
        mc.menuItem(p=mi, l="Poly Only", c=showOnly)
        mc.menuItem(p=mi, l="-" * 15, en=0)
        mc.menuItem(p=mi, l="All Hidden", c=showAllHidden)
        mc.menuItem(p=mi, l="-" * 15, en=0)
        mc.menuItem(p=mi, l="LRA", c=partial(display_LRA, 1, 0))
        mc.menuItem(p=mi, l="LRA Off", c=partial(display_LRA, 0, 0), ob=1)
        mc.menuItem(p=mi, l="LRA -hi", c=partial(display_LRA, 1, 1))
        mc.menuItem(p=mi, l="Nurbs CV", c=partial(display_CV, 1))
        mc.menuItem(p=mi, l="Nurbs CV Off", c=partial(display_CV, 0), ob=1)
        mc.menuItem(p=mi, l="-" * 15, en=0)
        mc.menuItem(p=mi, l="Joint Size = 1", c=partial(jointDisplay, 1))
        mc.menuItem(p=mi, l="Joint Size = 0.5", c=partial(jointDisplay, 0.5))
        mc.menuItem(p=mi, l="Joint Size = 0.1", c=partial(jointDisplay, 0.1))

        mi = mc.menuItem(p=menu, l="Connect", rp="W", subMenu=1)
        mc.menuItem(p=mi, l="T  to  T", c=partial(connect_channel, "t"))
        mc.menuItem(p=mi, l="R  to  R", c=partial(connect_channel, "r"))
        mc.menuItem(p=mi, l="S  to  S", c=partial(connect_channel, "s"))

        mi = mc.menuItem(p=menu, l="Offset", rp="N", subMenu=1)
        mc.menuItem(p=mi, l="Add Offset Group", c=add_ofs)
        mc.menuItem(p=mi, l="Add Offset Group ( below )", c=add_ofs_below)

        mi = mc.menuItem(p=menu, l="Channel", rp="E", subMenu=1)
        mc.menuItem(p=mi, l="Lock, Hide All", c=partial(lockAttr, "all", 1))
        mc.menuItem(p=mi, l="Lock Hide Off", c=partial(lockAttr, "all", 0), ob=1)
        mc.menuItem(p=mi, l="-" * 15, en=0)
        mc.menuItem(p=mi, l="Lock, Hide T", c=partial(lockAttr, "t", 1))
        mc.menuItem(p=mi, l="T off", c=partial(lockAttr, "t", 0), ob=1)
        mc.menuItem(p=mi, l="Lock Hide R", c=partial(lockAttr, "r", 1))
        mc.menuItem(p=mi, l="R off", c=partial(lockAttr, "r", 0), ob=1)
        mc.menuItem(p=mi, l="Lock, Hide S", c=partial(lockAttr, "s", 1))
        mc.menuItem(p=mi, l="S off", c=partial(lockAttr, "s", 0), ob=1)
        mc.menuItem(p=mi, l="Lock, Hide V", c=partial(lockAttr, "v", 1))
        ...
        mi = mc.menuItem(p=menu, l="Joint / IK", rp="SE", subMenu=1)
        mc.menuItem(p=mi, l="Single Chain", c=partial(add_IK, Solver.SC))
        mc.menuItem(p=mi, l="Rotate Plane", c=partial(add_IK, Solver.RP))
        mc.menuItem(p=mi, l="Spline", c=partial(add_IK, Solver.SPLINE))
        mc.menuItem(p=mi, l="Spring", c=partial(add_IK, Solver.SPRING))
        mc.menuItem(p=mi, l="2B", c=partial(add_IK, Solver.TWO_BONE))
        mc.menuItem(p=mi, l="-" * 15, en=0)
        # mc.menuItem(p=mi, l="LRA", c=partial(joint_LRA, 1))
        # mc.menuItem(p=mi, l="Hide LRA", c=partial(joint_LRA, 0), ob=1)
        mc.menuItem(p=mi, l="Create Chain x 10 ", c=makeJointChain10_mm)
        mc.menuItem(p=mi, l="Create Golden Chain ", c=makeJointChainGold_mm)

        mi = mc.menuItem(p=menu, l="Skin", rp="SW", subMenu=1)
        mc.menuItem(p=mi, l="Select Meshes / Joints related", c=skin.selSkinned)
        mc.menuItem(p=mi, l="-" * 15, en=0)
        ...
        mc.menuItem(p=menu, l="Sel Constrainer", c=select_constrainers)
        mc.menuItem(p=menu, l="Sel Constrained", c=select_constrained)
        mc.menuItem(p=menu, l="-" * 15, en=0)
