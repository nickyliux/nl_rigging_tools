...
//Name: lighting.ma
//Last modified: Fri, May 03, 2024 06:57:05 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "95298220-422A-F4AD-AED2-B4A058690B01";
createNode transform -n "group1";
	rename -uid "AD81FF5D-43BE-D98C-609C-CC99F614E812";
createNode transform -n "comp" -p "group1";
	rename -uid "F9B10333-448A-4CC7-DEB1-53923B2EAA0A";
	setAttr ".t" -type "double3" 0 479.9809560234396 0 ;
	setAttr ".r" -type "double3" 135.55397735765098 56.784560507595039 172.49173457063182 ;
	setAttr ".s" -type "double3" 81.331206122108895 81.331206122108895 81.331206122108895 ;
createNode directionalLight -n "compShape" -p "comp";
	rename -uid "CD9E91C9-4EE8-46EA-1070-3CB6542A48E8";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 1 0.81561428 0.71799999 ;
	setAttr ".in" 0.60000002384185791;
	setAttr ".urs" no;
	setAttr ".sc" -type "float3" 0.01923077 0.01923077 0.01923077 ;
	setAttr ".dms" yes;
	setAttr ".fs" 11;
createNode transform -n "main" -p "group1";
	rename -uid "8D12A950-4C06-4B25-0CCA-C0B1558FB267";
	setAttr ".t" -type "double3" 0 479.9809560234396 0 ;
	setAttr ".r" -type "double3" -31.19626562901589 12.575792764675333 12.645588065514723 ;
	setAttr ".s" -type "double3" 81.331206122108895 81.331206122108895 81.331206122108895 ;
createNode directionalLight -n "mainShape" -p "main";
	rename -uid "4465DA48-40CD-6BFA-E20D-43BC1CBDB298";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 0.50060999 0.6284157 0.81400001 ;
...
createNode transform -n "back" -p "group1";
	rename -uid "3AEC0713-4D4B-2D30-90C4-0392C8353B9C";
	setAttr ".t" -type "double3" 0 479.9809560234396 0 ;
	setAttr ".r" -type "double3" 183.73882800040553 59.286350064187673 -41.030834292941556 ;
	setAttr ".s" -type "double3" 81.331206122108895 81.331206122108895 81.331206122108895 ;
createNode directionalLight -n "backShape" -p "back";
	rename -uid "0E0F8266-4565-1D7D-3A73-509553AAB3A0";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 1 0.64700001 0.80622059 ;
...
createNode transform -n "pPlane1" -p "group1";
	rename -uid "1EE53836-42B6-DE0D-3B30-4AB0FFF4A2FA";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr ".s" -type "double3" 400 400 400 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "97A3DDD0-4C54-5775-BB91-C8BA88176A87";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPlane2" -p "group1";
	rename -uid "FBC2F23F-4748-657D-B307-AEA8661A3C51";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
...
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	rename -uid "43D1C629-47AB-E04B-3CBC-57B8A6783F45";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".csh" no;
...
createNode transform -n "pPlane3" -p "group1";
	rename -uid "F59F912C-4686-E1A3-31D4-6CAC11057AF2";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr ".t" -type "double3" -200 200 0 ;
	setAttr ".r" -type "double3" 90 90 0 ;
	setAttr ".s" -type "double3" 400 400 400 ;
createNode mesh -n "pPlaneShape3" -p "pPlane3";
	rename -uid "69B4745E-4B5E-53D6-A78A-C4AB46A4B43A";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".csh" no;
...
createNode transform -n "pPlane4" -p "group1";
	rename -uid "23ACAC41-45F9-10B1-E077-7090EC4F08E0";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr ".t" -type "double3" 200 200 0 ;
	setAttr ".r" -type "double3" 90 90 0 ;
...
createNode mesh -n "pPlaneShape4" -p "pPlane4";
	rename -uid "EA1B98E0-48AC-FB8A-EAE2-EA945D37C560";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".csh" no;
...
createNode transform -s -n "persp";
	rename -uid "099C9C94-4BD6-2C25-ADE3-6D96DB909BBC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 520.72664707735919 330.95629729231763 836.89318403101572 ;
	setAttr ".r" -type "double3" -15.938352729600744 33.399999999999118 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F3567054-4BD4-A995-D212-97A176EE3024";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1001.7554938377884;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 200 0 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "66EAB1F9-4BCA-CC74-090E-67A57B0471F5";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "020CD494-4F7F-A6CA-55FE-61AF47CB182A";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "20A08BA5-441E-C291-2C60-EE84B16C8302";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "242F0608-4A52-9DDB-924D-88BC7D846BAE";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "EFA83BB8-45D5-0EEC-70E4-538FA79A8D52";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "495923B0-4CEC-4FB1-D7C9-D6A5504EF16F";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode polyPlane -n "polyPlane1";
	rename -uid "C4C4748C-4580-7C30-23FC-43890514E7B3";
	setAttr ".sw" 5;
	setAttr ".sh" 5;
	setAttr ".cuv" 2;
createNode materialInfo -n "materialInfo5";
	rename -uid "B09F2F60-4E1F-7F1A-A747-15A6327E7048";
createNode shadingEngine -n "blinn4SG";
	rename -uid "4F877C19-49AF-E3D4-765A-2D8461D2CE97";
	setAttr ".ihi" 0;
	setAttr -s 4 ".dsm";
	setAttr ".ro" yes;
createNode blinn -n "blinn4";
	rename -uid "88BBF989-430A-0E43-65BA-2BB0C0C59163";
	setAttr ".c" -type "float3" 0.096153848 0.096153848 0.096153848 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EBEDC560-459F-3E4D-45D1-C7BE2B0081EE";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CFAAB03C-4B82-5CE0-8A4B-00BEC6C3EAA8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F59E9286-48B8-77A8-F21F-96B9AAF7BD40";
createNode displayLayerManager -n "layerManager";
	rename -uid "6CD488E5-458F-35CD-952E-29B940773C7B";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4C5F114-443B-8871-D6F8-AAA78AF53E60";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0DAF1B95-4F68-6CDE-5786-4F930E27A3DB";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "2DB20B80-43D1-3A76-9247-6AA78FD4FE6E";
	setAttr ".g" yes;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "0A7F04D2-4FCB-88A8-895C-BD9F2A75F1BD";
	setAttr ".version" -type "string" "5.2.1.1";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "3AE4FF48-4BD2-2C59-96FD-8796AD6AF762";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "31108944-45FC-585C-6E68-92AB8DB1F633";
	setAttr ".ai_translator" -type "string" "exr";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "1133848C-4868-951D-D47B-228C20C2BE1D";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "C8FA804B-4925-7F49-5DBD-AE87CC0A4A87";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "6FBEA923-4968-8AB3-B6DE-158083C3500D";
...
connectAttr "pPlaneShape3.iog" "blinn4SG.dsm" -na;
