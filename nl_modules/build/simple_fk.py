...
class SimpleFk(RigModule):
    ...
    def build_ctl(self):
        ...
        ctl_defs = [
            ...
            ("simple01_fkc", "squareR", "x", scale, 1, 3),
            ("simple02_fkc", "squareR", "x", scale, 0, 3),
        ]
        if self.segNum >= 2:
            ctl_defs.append(("simple03_fkc", "squareR", "x", scale, 0, 3))
        if self.segNum >= 3:
            ctl_defs.append(("simple04_fkc", "squareR", "x", scale, 0, 3))
        if self.segNum >= 4:
            ctl_defs.append(("simple05_fkc", "squareR", "x", scale, 0, 3))
