...
//Name: rtLegQd.ma
//Last modified: Mon, Aug 10, 2026 02:41:18 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "7C1A3A4F-4FD6-4172-F746-989C8649F412";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 113.58498343229897 132.81794449562921 80.777579313438935 ;
	setAttr ".r" -type "double3" -27.33835272901036 48.200000000001502 4.7717925583929544e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 186.62399228602325;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -9.9999999999999982 47.111944361380559 -29.720148752798512 ;
...
createNode nurbsCurve -n "toe1_2_guideShape" -p "toe2_2_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		8.8817841970012523e-16 0.5 -7.190999595204253e-15
		0 -1.265625 0
		0 0 1.1711366400095347e-08
		0 0 1.1711366400095347e-08
		;
...
createNode transform -n "toe2_1_guide" -p "toe2_2_guide";
	...
	setAttr -l on ".sy";
	setAttr -l on ".sz";
createNode nurbsCurve -n "toe3_1_guideShape" -p "toe2_1_guide";
...
createNode nurbsCurve -n "curveShape4" -p "|master_guide|line_grp_mammalFoot|toe_line_grp1|line_35";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-6 5.0000000000000009 -45
		-5.9999999999999982 4.9999999999999956 -38
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape5" -p "|master_guide|line_grp_mammalFoot|toe_line_grp1|line_36";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-5.9999999999999982 4.9999999999999956 -38
		-6.0000000000002593 -4.4408920985006262e-15 -36.000000000000014
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape9" -p "|master_guide|line_grp_mammalFoot|toe_line_grp2|line_40";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-8.0000000000002593 0 -36
		-8.0000000000002593 -1.9915985002008819e-16 -34
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape11" -p "|master_guide|line_grp_mammalFoot|toe_line_grp3|line_42";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 5.0000000000000009 -45
		-9.9999999999999982 4.9999999999999964 -38
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape12" -p "|master_guide|line_grp_mammalFoot|toe_line_grp3|line_43";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-9.9999999999999982 4.9999999999999964 -38
		-10.000000000000259 -3.5527136788005009e-15 -36
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape13" -p "line_44";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10.000000000000259 -3.5527136788005009e-15 -36
		-10.000000000000259 -3.7518735288210932e-15 -34
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape15" -p "line_46";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12 5.0000000000000009 -45
		-11.999999999999998 4.9999999999999938 -38
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape16" -p "line_47";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-11.999999999999998 4.9999999999999938 -38
		-12.000000000000259 -6.2172489379008766e-15 -36
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape17" -p "line_48";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12.000000000000259 -6.2172489379008766e-15 -36
		-12.000000000000259 -6.4164087879219715e-15 -34
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape19" -p "line_50";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14 5.0000000000000009 -45
		-13.999999999999998 4.9999999999999947 -38
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape20" -p "line_51";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-13.999999999999998 4.9999999999999947 -38
		-14.000000000000259 -5.3290705182007514e-15 -36
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape21" -p "line_52";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14.000000000000259 -5.3290705182007514e-15 -36
		-14.000000000000263 -5.5282303682218462e-15 -34
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape70" -p "|master_guide|line_grp_birdFoot|group_toe_0|line_42";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-10 4.8985871965894128e-16 -46
		-10 3.0616169978683846e-16 -47.5
		;
...
createNode nurbsCurve -n "curveShape71" -p "|master_guide|line_grp_birdFoot|group_toe_0|line_43";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 3.0616169978683846e-16 -47.5
		-10 -6.1232339957367377e-17 -50.5
		;
...
createNode nurbsCurve -n "curveShape72" -p "line_53";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 -6.1232339957367377e-17 -50.5
		-10 -4.2862637970157346e-16 -53.5
		;
...
createNode nurbsCurve -n "curveShape58" -p "line_30";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-4.0499999999999954 1.7847575658260706e-15 -35.426348502534061
		-5.6999999999999957 1.4347677370468509e-15 -38.284232335022708
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape59" -p "line_31";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-5.6999999999999957 1.4347677370468509e-15 -38.284232335022708
		-7.3499999999999979 1.0847779082676315e-15 -41.142116167511354
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape61" -p "|master_guide|line_grp_birdFoot|group_toe_2|line_33";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-10 8.5725275940314722e-16 -43
		-10 1.2246467991473531e-15 -40
		;
...
createNode nurbsCurve -n "curveShape65" -p "|master_guide|line_grp_birdFoot|group_toe_3|line_37";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-11 7.3478807948841207e-16 -44
		-12 9.4690312723339331e-16 -42.267949192431125
		;
...
createNode nurbsCurve -n "curveShape66" -p "|master_guide|line_grp_birdFoot|group_toe_3|line_38";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12 9.4690312723339331e-16 -42.267949192431125
		-13 1.1590181749783741e-15 -40.53589838486225
		;
...
createNode nurbsCurve -n "curveShape67" -p "|master_guide|line_grp_birdFoot|group_toe_3|line_39";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-13 1.1590181749783741e-15 -40.53589838486225
		-14 1.371133222723355e-15 -38.803847577293375
		;
...
createNode nurbsCurve -n "curveShape68" -p "|master_guide|line_grp_birdFoot|group_toe_3|line_40";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14 1.371133222723355e-15 -38.803847577293375
		-15 1.583248270468336e-15 -37.0717967697245
		;
...
createNode nurbsCurve -n "curveShape69" -p "|master_guide|line_grp_birdFoot|group_toe_3|line_41";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-15 1.583248270468336e-15 -37.0717967697245
		-15.999999999999998 1.7953633182133171e-15 -35.339745962155618
		;
...
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe2_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe3_1_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe3_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe0_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe1_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe1_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe2_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe0_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe3_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe1_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe4_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe3_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe4_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe2_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe4_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe_main_2_guide_ofs|toeMain_guide|toe2_2_guide_ofs|toe2_2_guide|toe2_1_guide|toe3_1_guideShape" "toe1_1_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "ACAC6BD3-4D39-7505-7DB0-CB8753A99B49";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "92BE1E0A-4337-F717-0F9B-F6A13D676F9A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AD448072-4B58-9FD4-D60E-9BA1130E0ACF";
createNode displayLayerManager -n "layerManager";
	rename -uid "AB1F8ED8-4218-EF0E-C0D2-EA8A76B7AA64";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9395A194-452E-4137-D681-128761FEB1F6";
