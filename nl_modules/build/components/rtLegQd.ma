...
//Name: rtLegQd.ma
//Last modified: Sat, Apr 12, 2025 11:32:35 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "3E99C6BA-4419-262C-D4FD-13AE04AFC02C";
...
createNode transform -n "master_guide" -p "module_grp";
	...
	setAttr -cb on ".autoUpWeight" 1;
	setAttr -cb on ".autoFwWeight" 1;
	setAttr -cb on ".autoDnWeight" 1;
	setAttr -cb on ".autoBkWeight" 1;
...
createNode nurbsCurve -n "line_15Shape" -p "line_15";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-8 1.2412295168563667 -36.631919426697323
		-8 1.241229516856367 -34.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_19Shape" -p "line_19";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 1.2412295168563667 -36.631919426697323
		-10 1.241229516856367 -34.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_23Shape" -p "line_23";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12 1.2412295168563667 -36.631919426697323
		-12 1.241229516856367 -34.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_27Shape" -p "line_27";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14 1.2412295168563667 -36.631919426697323
		-14 1.241229516856367 -34.631919426697323
		;
	setAttr ".adot" yes;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 89.561702694554569 66.967029903987765 51.49776785751412 ;
	setAttr ".r" -type "double3" -6.938352728919102 52.600000000034733 -6.5456889981725791e-16 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 163.7730091418704;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3A4889C7-44E8-D10A-A842-DDA12BDF395B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6F835AF3-4792-9064-B3E0-7EBD2F5B58C2";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F4F822DB-4FA6-4D3C-B343-8D906BCC6BA1";
createNode displayLayerManager -n "layerManager";
	rename -uid "4F46BFE0-4D2D-94A2-AD0B-C7827935348F";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5D84EC94-4C44-47E3-C07A-15B768829A91";
