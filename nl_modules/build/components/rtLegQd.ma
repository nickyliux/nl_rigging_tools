...
//Name: rtLegQd.ma
//Last modified: Thu, Aug 21, 2025 09:26:04 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "894D53C9-475D-1159-291C-A28E3241318A";
...
createNode pointConstraint -n "toe02_1_guide_ofs_pointConstraint1" -p "toe02_1_guide_ofs";
	rename -uid "99DBE478-48B0-ED99-4D27-118E8B774EE6";
...
createNode scaleConstraint -n "toe02_2_guide_ofs_scaleConstraint1" -p "toe02_2_guide_ofs";
	rename -uid "A003D91E-4686-E93A-6788-098382922AF6";
...
createNode pointConstraint -n "toe01_1_guide_ofs_pointConstraint1" -p "toe01_1_guide_ofs";
	rename -uid "CBD49412-4BAC-60EC-B9C1-0CBBCC0DDF80";
...
createNode scaleConstraint -n "toe01_2_guide_ofs_scaleConstraint1" -p "toe01_2_guide_ofs";
	rename -uid "C2C7FABD-49AF-8A6A-0D7E-6EA868230C8D";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "toe04_2_guideW0" -dv 1 -min 0 -at "double";
	addAttr -dcb 0 -ci true -k true -sn "w1" -ln "toe00_2_guideW1" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
...
createNode pointConstraint -n "toe03_1_guide_ofs_pointConstraint1" -p "toe03_1_guide_ofs";
	rename -uid "D24F4D1D-4E86-E688-0AA7-47BA11832F30";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "toe04_1_guideW0" -dv 1 -min 0 -at "double";
	addAttr -dcb 0 -ci true -k true -sn "w1" -ln "toe00_1_guideW1" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
...
createNode scaleConstraint -n "toe03_2_guide_ofs_scaleConstraint1" -p "toe03_2_guide_ofs";
	rename -uid "3D5921C9-4BCC-96AB-8E84-D3BB1FA6EF5A";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "toe04_2_guideW0" -dv 1 -min 0 -at "double";
	addAttr -dcb 0 -ci true -k true -sn "w1" -ln "toe00_2_guideW1" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 66.400391381685864 97.835605927886661 54.846647758686281 ;
	setAttr ".r" -type "double3" -22.538352728963805 40.600000000061854 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 124.73426068832418;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CAD7B6F9-4B8B-B9A7-AA26-3D8D07746DEB";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C35851B4-4292-33E2-1ACD-F7A0F5741FC9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E6549190-4F10-E611-A8F1-77B342777025";
createNode displayLayerManager -n "layerManager";
	rename -uid "8E1B19EA-4258-A11D-94DC-6EB325B1D0E1";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8E922FB9-44D4-97E6-65DE-FBAD19DE535D";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "3CE632DD-4487-A679-0B61-72B050E48A0A";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 925.74384938641879 -801.4367811781608 ;
	setAttr ".tgi[0].vh" -type "double2" 1962.344230760021 -34.472337156073536 ;
	setAttr -s 5 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1224.008056640625;
	setAttr ".tgi[0].ni[0].y" -137.07345581054688;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" 922.85711669921875;
	setAttr ".tgi[0].ni[1].y" -138.57142639160156;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 1537.142822265625;
	setAttr ".tgi[0].ni[2].y" -138.57142639160156;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" 1537.142822265625;
	setAttr ".tgi[0].ni[3].y" -272.85714721679688;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" 1550.0638427734375;
	setAttr ".tgi[0].ni[4].y" -358.07962036132812;
