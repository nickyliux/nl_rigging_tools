...
//Name: rtLegQd.ma
//Last modified: Mon, May 26, 2025 04:17:19 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "B5FB6207-44A4-268F-CD2D-08B753DEA1DD";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 267.61217095828869 166.93547067960947 151.02313728895027 ;
	setAttr ".r" -type "double3" -20.138352728919127 51.800000000034863 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 383.0014980812;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "04B0FD5E-4188-F7AB-36DF-D0866E1DD4A5";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A6BFD56C-46A3-F7C7-5E80-EBB085AC723B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "013D0BB7-4D3C-134F-5E9D-C4BABF01E54F";
createNode displayLayerManager -n "layerManager";
	rename -uid "694D16A1-4397-BEF6-0A3A-F09CB54F843D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1F68DBE6-432C-A4B4-A150-DC97806C8CA0";
