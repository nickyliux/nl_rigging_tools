...
//Name: rtLegQd.ma
//Last modified: Thu, Jun 26, 2025 05:50:33 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "6DDD1C65-43B1-9279-9102-5D89C3D857C8";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 214.00260011648263 149.08129311182415 193.36805309113868 ;
	setAttr ".r" -type "double3" -17.738352728945593 39.40000000005162 -1.0289945948222648e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 313.21822724901074;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "91332504-482C-2A40-5E67-6AB4D73D5E1F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5F66F8B8-4CA4-6BD7-827C-1591C61684FA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6099093B-46BE-4DEA-CF70-03BE95CAA398";
createNode displayLayerManager -n "layerManager";
	rename -uid "ABD6B27A-4046-E3EF-A7F1-9EA07356AD2A";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "42CED3D0-4EBC-8C8B-791B-DA8E8BB9BDAE";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "3F11FFD5-4B3B-3398-8D2A-5C994D3A5A43";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 53.339949064945493 -249.55483218267798 ;
	setAttr ".tgi[0].vh" -type "double2" 1337.9490800917426 231.8175472929955 ;
	setAttr -s 6 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 864.27691650390625;
	setAttr ".tgi[0].ni[0].y" -18.567035675048828;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 861.4285888671875;
	setAttr ".tgi[0].ni[1].y" 117.14286041259766;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 548.80743408203125;
	setAttr ".tgi[0].ni[2].y" 44.724498748779297;
	...
	setAttr ".tgi[0].ni[5].x" 202.427734375;
	setAttr ".tgi[0].ni[5].y" 150.10774230957031;
...
connectAttr "master_guide.scapularExtra" "scapHelper_guide.v";
...
connectAttr "line_53.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
connectAttr "curveShape22.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "scapHelper_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "foot_guide_quadShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "|module_grp|master_guide|scapHelper_guide_ofs|scapHelper_guide|hip_guideShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
