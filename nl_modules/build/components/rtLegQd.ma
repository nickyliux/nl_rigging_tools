...
//Name: rtLegQd.ma
//Last modified: Thu, May 29, 2025 01:04:55 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "FD7D0F8D-4F94-52B5-70E9-8D92BBFB1FD6";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 139.66313000837482 107.96930990304264 93.93921606867508 ;
	setAttr ".r" -type "double3" -15.338352728933529 42.200000000048739 3.2200340319920636e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 206.52093436899096;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "33467518-4400-ED96-F023-3580C717AD81";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "06B4CD6F-4AC1-3764-573A-B8AEE8DA595E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "603CE782-4DD9-BEF2-8685-119EB1D914F6";
createNode displayLayerManager -n "layerManager";
	rename -uid "182C8A70-414C-116E-EC1F-ADA8A8755836";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "774D4498-4FC6-3612-0450-A9A7D41A58FE";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "0E7EA1D3-4323-68C9-58D9-A786909803B4";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 31.809353683662739 -249.99999006589289 ;
	setAttr ".tgi[0].vh" -type "double2" 928.90489385526871 63.095235588058685 ;
	...
	setAttr ".tgi[0].ni[2].x" 417.38601684570312;
	setAttr ".tgi[0].ni[2].y" -16.622564315795898;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" 600;
	setAttr ".tgi[0].ni[3].y" 5.7142858505249023;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" 136.36341857910156;
	setAttr ".tgi[0].ni[4].y" -5.7748260498046875;
...
connectAttr "toesRoot_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
