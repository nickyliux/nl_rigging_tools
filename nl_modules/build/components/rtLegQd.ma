...
//Name: rtLegQd.ma
//Last modified: Tue, Jun 30, 2026 12:08:22 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "0F008904-4382-A670-11CC-B7B28A91DF9A";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 82.973329689135113 77.726823071115319 113.62939116921187 ;
	setAttr ".r" -type "double3" -12.338352729005317 51.400000000016725 1.2745066108269588e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 136.12475007062713;
...
createNode nurbsCurve -n "toe1_up_guideShape" -p "toe0_up_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		0 -1.2980767825169972e-31 -0.15742001795705035
		...
		0 -0.06054169861333298 -0.14616059619464458
		0 -1.2980767825169972e-31 -0.15742001795705035
		0 -1.2980767825169972e-31 -1.2656250000000009
		0 -1.2980767825169972e-31 -1.1711366984697158e-08
		0 -0.6328125 -5.8460181140418399e-16
		0 -1.2980767825169972e-31 1.1711365815493535e-08
		0 -1.2980767825169972e-31 1.1711365815493535e-08
		;
	setAttr ".adot" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9BA51FF5-49E8-C0BF-C85D-B6802B923A37";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FB2916EC-419A-7BE5-ECC6-47B346A71121";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "30B6C3F7-48D0-7E23-71DF-C7A459E214EE";
createNode displayLayerManager -n "layerManager";
	rename -uid "F0249DA8-403F-B428-9759-568853E07121";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7DDB0CC1-46D9-7605-0C8E-1FA49C68082F";
