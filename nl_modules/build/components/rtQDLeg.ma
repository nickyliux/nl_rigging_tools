...
//Name: rtQDLeg.ma
//Last modified: Tue, Dec 24, 2024 01:14:43 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "4562646E-44B1-1192-CEC2-DDBD94E37FFD";
...
createNode transform -n "hip_guide_ofs" -p "master_guide";
	...
	setAttr ".t" -type "double3" 3 94 18 ;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "C8A38E8E-4CC2-9C93-1EB7-4999177FE819";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr ".cc" -type "nurbsCurve" 
...
createNode nurbsCurve -n "line_06Shape" -p "line_06";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-8.500000000000993 52.499999999999993 -2.5
		-8.5 52.5 -34.5
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_10Shape" -p "line_10";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-6 5 -44
		-5.9999999999999964 5 -40.399999999999999
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_11Shape" -p "line_11";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-5.9999999999999964 5 -40.399999999999999
		-5.9999999999999964 4.9999999999999991 -39.399999999999999
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_14Shape" -p "line_14";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-8 5.0000000000000009 -38
		-8 1.2412295168563667 -36.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_15Shape" -p "line_15";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-8 1.2412295168563667 -36.631919426697323
		-8 1.9252698035077045 -34.752534185125505
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_18Shape" -p "line_18";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 5.0000000000000009 -38
		-10 1.2412295168563667 -36.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_19Shape" -p "line_19";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10 1.2412295168563667 -36.631919426697323
		-10 1.9252698035077045 -34.752534185125505
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_22Shape" -p "line_22";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12 5.0000000000000009 -38
		-12 1.2412295168563667 -36.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_23Shape" -p "line_23";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12 1.2412295168563667 -36.631919426697323
		-12 1.9252698035077045 -34.752534185125505
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_26Shape" -p "line_26";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14 5.0000000000000009 -38
		-14 1.2412295168563667 -36.631919426697323
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_27Shape" -p "line_27";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14 1.2412295168563667 -36.631919426697323
		-14 1.9252698035077045 -34.752534185125505
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-3.7109122047417697 47.81491233061206 -36.761547763735834
...
createNode nurbsCurve -n "line_08Shape" -p "line_08";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-13.700278303228623 48.275959996696074 -36.761547763735841
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 133.29680243679377 108.96785784217823 43.829757536253936 ;
	setAttr ".r" -type "double3" -15.938352728925512 62.600000000037163 -1.7278119126899151e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 182.2112885951754;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "07F35938-4A99-C5F4-7B9D-53A2D7F5F085";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FC908625-4FFF-3911-5099-B99E7019B8D7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B3D77F0A-46B2-C3A1-BBC3-83A6FA880282";
createNode displayLayerManager -n "layerManager";
	rename -uid "CA6C94A0-4229-3F83-2FB3-C6BA7D3D20B8";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "00187934-47F4-2008-4DF9-99AA6122DAC1";
