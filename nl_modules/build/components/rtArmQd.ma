...
//Name: rtArmQd.ma
//Last modified: Tue, May 27, 2025 03:31:14 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D874B9B5-4D78-1FA7-B765-E0BEFD2AD6F1";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 226.6602432384407 128.36319569578586 258.53951223227386 ;
	setAttr ".r" -type "double3" -16.538352728920565 49.400000000045509 1.2218349302578316e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 324.98442505314063;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -10.000000000000007 45.120175828370932 52.095222237046464 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EF05C4C8-45D2-72C3-ED27-45B95C21AF39";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "78C4B54A-464B-55C9-E728-E180B85F2A58";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C3F5C156-4BF0-CF71-A4FA-48A46BA3234F";
createNode displayLayerManager -n "layerManager";
	rename -uid "5219C85A-4C2E-D10E-9749-C997F655893B";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5CEC3858-4E93-7163-7E91-A0ADBA982C4E";
