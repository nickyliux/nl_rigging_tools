...
//Name: lfSimpleFk.ma
//Last modified: Thu, Apr 16, 2026 02:23:00 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "8B9C950C-40C3-5C65-2D29-7780845771E3";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 99.491797279834316 55.837187447429898 93.661359130079603 ;
	setAttr ".r" -type "double3" -23.138352729831094 35.000000000001563 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 111.53319499219836;
...
createNode nurbsCurve -n "master_guideShape1" -p "master_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		-2.1247938926458838e-16 -10.35221232054587 5.1761061602729423
		-3.0049123402273352e-16 -5.7316629368952354e-16 4.6802579657137366
		-2.1247938926458826e-16 10.35221232054587 5.1761061602729379
		1.2264028035457898e-31 14.693849264760836 2.4704764348701863e-15
		2.1247938926458838e-16 10.35221232054587 -5.1761061602729352
		3.0049123402273377e-16 9.376492828010726e-16 -4.6802579657137411
		2.1247938926458826e-16 -10.35221232054587 -5.1761061602729379
		1.791956824759815e-31 -9.3605159314275017 9.3646094962163239e-16
		-2.1247938926458838e-16 -10.35221232054587 5.1761061602729423
		-3.0049123402273352e-16 -5.7316629368952354e-16 4.6802579657137366
		-2.1247938926458826e-16 10.35221232054587 5.1761061602729379
		;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "94D8C8DE-495E-20CF-04A5-508728A41DFE";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5C6DCFEB-4732-CA59-65E8-9F903282BAF1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8B083CE5-40C8-28EA-FDD2-3787A0B16F1F";
createNode displayLayerManager -n "layerManager";
	rename -uid "BB3AA8AB-4C41-9895-B2F6-6FB627D58BA6";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5AEC7B01-4D3E-747B-7840-1B841354B891";
