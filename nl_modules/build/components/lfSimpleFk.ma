...
//Name: lfSimpleFk.ma
//Last modified: Sun, May 03, 2026 04:51:33 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "30FC8A8C-435D-1265-C5B3-B7B8E77BCF62";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 146.134527220244 73.652711425001215 134.02819314434637 ;
	setAttr ".r" -type "double3" -23.138352729831158 33.00000000000145 9.4809416325867241e-16 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 173.93568321459057;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "5331B96D-4822-CB3C-4CF8-84B38913B86A";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 1;
	setAttr ".ls" 2;
	setAttr ".cc" -type "nurbsCurve" 
		...
		6 0 1 3 4 6 7
		6
		0 8.3857666503442303 1.0269602286740684e-15
		0 5.6250000000000027 -5.6249999999999982
		0 -5.6249999999999982 -5.6250000000000018
		0 -5.625 5.6249999999999982
		0 5.6250000000000018 5.6250000000000018
		0 8.3857666503442303 1.0269602286740684e-15
		;
	setAttr ".adot" yes;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BA02EB48-4AD3-5F5F-76D8-8B95B4DF7CE5";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6F972B9E-494A-9EDE-E91B-B59C786B71DB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "49557701-43D0-5576-9355-04BB0D7A5A28";
createNode displayLayerManager -n "layerManager";
	rename -uid "6EDC22BE-47B9-CE90-F1FF-E7BBEA892D48";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C3F4CD64-4567-3220-4074-059F9C0D310E";
