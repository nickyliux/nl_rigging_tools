...
//Name: lfSimpleFk.ma
//Last modified: Sat, Apr 25, 2026 10:56:01 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "7FD880FF-4967-64C6-1E66-74ABDE10F87D";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 162.90462568854224 113.65079323408551 182.69619597113859 ;
	setAttr ".r" -type "double3" -25.538352729831015 30.600000000001373 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 237.31958550908956;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D5859738-4DA6-3C8D-CD4E-77B4CCDB6B8F";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B769E920-48C6-21FB-12C8-328463644288";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "01FB599A-4F8A-9AB1-43C4-DDA2FB515305";
createNode displayLayerManager -n "layerManager";
	rename -uid "C9C80E1B-416D-33FE-86E7-579D79E460AC";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6DFC8AE8-478D-7051-75A6-F7BB40353BA7";
