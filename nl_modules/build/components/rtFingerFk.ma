...
//Name: rtFingerFk.ma
//Last modified: Sat, Apr 25, 2026 11:08:41 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "FE2DD07F-4F7F-43BC-03CB-BCA34FFB2720";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 48.525106681295 45.747022448047233 86.87495977582148 ;
	setAttr ".r" -type "double3" -21.338352729792522 36.200000000007876 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 149.96807710840869;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "3AC74AA7-4D04-06DA-D3F8-DFAF31EE8698";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 1;
	setAttr ".ls" 2;
	setAttr ".cc" -type "nurbsCurve" 
		...
		6 0 1 3 4 6 7
		6
		0 -6.2893249877581727 -7.7022017150555128e-16
		0 -4.2187500000000018 4.2187499999999982
		0 4.2187499999999982 4.2187500000000018
		0 4.21875 -4.2187499999999982
		0 -4.2187500000000018 -4.2187500000000018
		0 -6.2893249877581727 -7.7022017150555128e-16
		;
	setAttr ".adot" yes;
parent -s -nc -r -add "|master_guide|fgrRef_grp|fgrRef1|fgrRefShape" "fgrRef2" ;
parent -s -nc -r -add "|master_guide|fgrRef_grp|fgrRef1|fgrRefShape" "fgrRef3" ;
parent -s -nc -r -add "|master_guide|fgrRef_grp|fgrRef1|fgrRefShape" "fgrRef4" ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AC727AA4-48FD-4B65-175C-299AC11E19BD";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AFA41BDE-4AC2-CEBD-44B3-C6B5D278C9D4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F77D06AE-4D8C-B167-B968-7DBA91E90AF8";
createNode displayLayerManager -n "layerManager";
	rename -uid "CABA0D62-442A-EFA2-CF95-279739D0E76D";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7BD9C268-41DB-3735-4029-08844333B5D1";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "75BF4CAE-48FC-9449-DC98-FBA436D1719B";
