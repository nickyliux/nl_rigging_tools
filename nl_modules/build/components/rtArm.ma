...
//Name: rtArm.ma
//Last modified: Wed, Jan 08, 2025 12:39:47 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2E5BDC75-49D9-5FDB-AD45-B5ADF2AB295A";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -94.89090049281657 192.85449545890793 35.408412386783816 ;
	setAttr ".r" -type "double3" -44.738352729778924 -45.800000000005319 4.5621254828173969e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 91.923269058461457;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C484FF6B-424A-78C8-31DB-6CA8870CE6AB";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8519E116-4AB6-3755-43DB-58A4210AC2BD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "49058E6D-431C-27E8-94C3-3C89D407D81A";
createNode displayLayerManager -n "layerManager";
	rename -uid "81B0215A-4740-F928-C526-C6A65CB4BD6E";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "063072A4-4D11-3CBB-83D4-A7B57F212592";
