...
//Name: rtArm.ma
//Last modified: Mon, Dec 09, 2024 10:47:18 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2AE77F28-4D79-100F-011F-DB800B0FB4FF";
...
createNode nurbsCurve -n "clavicle_guideShape" -p "clavicle_guide";
	rename -uid "23AD8128-43E0-99D3-4B5A-14B380013091";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 22;
...
createNode transform -n "lwr_guide" -p "lwr_guide_ofs";
	...
	setAttr -l on -k off ".v";
	setAttr ".ovc" 1;
	setAttr ".t" -type "double3" 0 -6.1789887804542972e-16 0.1 ;
	setAttr -k off ".ry";
	setAttr -k off ".rx";
	setAttr -k off ".rz";
	setAttr -cb on ".ro";
...
createNode transform -n "ball_guide_ofs" -p "palm_guide";
	...
	setAttr ".t" -type "double3" -8 -1.0763591960058273e-14 2.8421709430404001e-14 ;
...
createNode nurbsCurve -n "line_1Shape" -p "line_1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		-15.000000000000002 145 -1.5665344633240752e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_2Shape" -p "line_2";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-15.000000000000002 145 -1.5665344633240752e-14
		-41.999999523162842 145 -0.10000000000001745
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_4Shape" -p "line_4";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-68.999999046325684 145 -1.744169538094475e-14
		-76.999999046325684 145 -4.5863404811348754e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_5Shape" -p "line_5";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-41.999999523162842 145 -0.10000000000001745
		-42.148146657831582 145.00000000000003 -40.099725654390312
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_6Shape" -p "line_6";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-41.99999952316287 149 -0.10000000000001785
...
createNode nurbsCurve -n "line_7Shape" -p "line_7";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-41.999999523162799 141 -0.10000000000001712
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -97.246835021299759 196.63842265989879 37.25539389791485 ;
	setAttr ".r" -type "double3" -38.13835272977942 -48.200000000004309 2.3858962791966073e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 105.48145305083129;
...
parent -s -nc -r -add "|module_grp|master_guide_ofs|master_guide|clavicle_guide_ofs|clavicle_guide|clavicle_guideShape" "palm_guide" ;
parent -s -nc -r -add "|module_grp|master_guide_ofs|master_guide|clavicle_guide_ofs|clavicle_guide|clavicle_guideShape" "ball_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "50CC923F-47B9-E0CE-7735-D7B481BA71BE";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7738C248-443E-4EED-4491-87B03D7EE644";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "66193F7C-46DE-9850-B7E0-76AD1FE91EE7";
createNode displayLayerManager -n "layerManager";
	rename -uid "822B9B6E-4CF0-13F7-80FD-FAA4B375B098";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "397353D0-4775-D652-1489-87A85A4D06CA";
