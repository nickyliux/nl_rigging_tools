...
//Name: rtSimpleFk.ma
//Last modified: Thu, Apr 16, 2026 02:23:09 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "15FA259E-4BDA-EF8F-D8D2-DBB1CBC08392";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 46.8889805263032 51.086582916072402 66.181261668596406 ;
	setAttr ".r" -type "double3" -24.938352729795216 52.200000000007492 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 131.47075111317423;
...
createNode nurbsCurve -n "master_guideShape1" -p "master_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		1.2264028035457898e-31 9.3605159314275017 1.8173314753249314e-15
		...
		2.1247938926458826e-16 -10.35221232054587 -5.1761061602729379
		1.791956824759815e-31 -14.693849264760836 9.3646094962163239e-16
		-2.1247938926458838e-16 -10.35221232054587 5.1761061602729423
		-3.0049123402273352e-16 -5.7316629368952354e-16 4.6802579657137366
		-2.1247938926458826e-16 10.35221232054587 5.1761061602729379
		;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6EFAC264-42FF-A294-633D-3E80FF95B635";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B45E7829-4610-4AEB-C5BE-949661E4F5E8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "463DCD1B-48D8-B879-2CC4-AFA12A4FB0FD";
createNode displayLayerManager -n "layerManager";
	rename -uid "6D8540CB-4929-EFEE-BCC1-EFAAF27C4663";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6E7A9A07-46BA-ED5D-DE6D-EBA9733B0AAF";
