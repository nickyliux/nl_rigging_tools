...
//Name: rtArmBp.ma
//Last modified: Wed, Mar 11, 2026 12:34:31 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "8A701469-49C4-2204-1E5C-DAA2725C6820";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 26.508133415997129 27.354515483421491 55.130700771497843 ;
	setAttr ".r" -type "double3" -28.53835272979499 37.799999999978461 -2.0126143804997783e-15 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C7A6AD83-4601-693F-A4B1-67A0543E5F37";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "592A8005-4869-3B2C-FB46-F7ABBCBA7CC3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3D1FC44C-4599-A5AD-2D2F-E086E353BEC8";
createNode displayLayerManager -n "layerManager";
	rename -uid "59ADEE54-44AF-4386-85B5-4A9E582C7808";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "362F7756-415C-DBBF-DF64-16A2EBD4F95A";
