...
//Name: rtArmBp.ma
//Last modified: Wed, Apr 08, 2026 01:32:30 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "260DE171-40CC-AB1B-1D8F-DD9F716448FF";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -81.516380439925172 57.647396971688998 65.284526997038199 ;
	setAttr ".r" -type "double3" -39.338352729795332 -39.00000000002143 -2.046304580610358e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 94.878187413163317;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B731A421-4B2A-4CA7-1650-F8B166FF123F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "395BA0DA-4CBF-BB93-9DD6-E59D2352763E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "85DF87C3-4272-F62B-6EA8-B29047D0B5B2";
createNode displayLayerManager -n "layerManager";
	rename -uid "2EA159CC-4E76-0266-9C19-B5BA59461E27";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8031D9E8-45C4-09F6-0C69-3584BFBFBADF";
