...
//Name: rtArmBp.ma
//Last modified: Tue, Mar 10, 2026 02:52:14 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "B6CCA085-48DD-C3F9-2027-339AFA89DE0E";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 28.037158656528693 26.217847360823349 54.726976960352957 ;
	setAttr ".r" -type "double3" -28.53835272979499 37.799999999978454 -2.0126143804997783e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 68.08580809138158;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "62747228-44C4-D2F3-2A69-059484BFD809";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4A8E788E-43CE-6079-F0FB-BA85B4637D96";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CAC809ED-4F38-26B4-C0BA-A78E1B1F4371";
createNode displayLayerManager -n "layerManager";
	rename -uid "284E7945-4CE7-7FE3-C439-B2A15E8D9FD3";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FC429934-42D6-AB32-67D0-FEA2663702E6";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "ACCFB8EC-4832-F01B-9C23-A8BB899F554B";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 2629.7618002645595 -4231.7168275880667 ;
	setAttr ".tgi[0].vh" -type "double2" 4909.5236144368691 3942.0633354199686 ;
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "BFB77C14-4639-5FB1-0FD2-68BEE337A6B4";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1110.1647910508509 -2015.4761103883657 ;
	setAttr ".tgi[0].vh" -type "double2" 1760.1647652221709 -1238.0951888977556 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -287.14285278320312;
	setAttr ".tgi[0].ni[0].y" -1497.142822265625;
	...
	setAttr ".tgi[0].ni[3].y" -1507.142822265625;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" 58.809059143066406;
	setAttr ".tgi[0].ni[4].y" -1496.1112060546875;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" 369.04669189453125;
	setAttr ".tgi[0].ni[5].y" -1552.063232421875;
	setAttr ".tgi[0].ni[5].nvs" 18304;
	setAttr ".tgi[0].ni[6].x" 43.335189819335938;
	setAttr ".tgi[0].ni[6].y" -1608.01513671875;
	setAttr ".tgi[0].ni[6].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -494.27712837391914 -1793.4923691263011 ;
	setAttr ".tgi[1].vh" -type "double2" 941.30416919672666 -875.78655290740039 ;
	setAttr -s 13 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -25.714284896850586;
	setAttr ".tgi[1].ni[0].y" -1278.5714111328125;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 281.42855834960938;
	setAttr ".tgi[1].ni[1].y" -1278.5714111328125;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 588.5714111328125;
	setAttr ".tgi[1].ni[2].y" -1331.4285888671875;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 281.42855834960938;
	setAttr ".tgi[1].ni[3].y" -1385.7142333984375;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -17.235069274902344;
	setAttr ".tgi[1].ni[4].y" -1624.098876953125;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -293.6092529296875;
	setAttr ".tgi[1].ni[5].y" -726.808837890625;
	setAttr ".tgi[1].ni[5].nvs" 18314;
	setAttr ".tgi[1].ni[6].x" 281.42855834960938;
	setAttr ".tgi[1].ni[6].y" -1142.857177734375;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -17.235069274902344;
	setAttr ".tgi[1].ni[7].y" -1488.384521484375;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" 593.2919921875;
	setAttr ".tgi[1].ni[8].y" -1090.1448974609375;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -25.714284896850586;
	setAttr ".tgi[1].ni[9].y" -1035.7142333984375;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -25.714284896850586;
	setAttr ".tgi[1].ni[10].y" -1385.7142333984375;
	setAttr ".tgi[1].ni[10].nvs" 18304;
	setAttr ".tgi[1].ni[11].x" 281.42855834960938;
	setAttr ".tgi[1].ni[11].y" -1035.7142333984375;
	setAttr ".tgi[1].ni[11].nvs" 18304;
	setAttr ".tgi[1].ni[12].x" -25.714284896850586;
	setAttr ".tgi[1].ni[12].y" -1142.857177734375;
...
connectAttr "pv_loc_ofs_pointConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "pvc_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "upr_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn";
connectAttr "palm_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
connectAttr "pv_loc_ofs.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
connectAttr "pv_loc_ofs_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "lwr_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
connectAttr "radiusEnd_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "rt_forearm_fix_DCM_2.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "line_6Shape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "rt_forearm_fix_DCM_1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "line_7.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "master_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "rt_forearm_fix_DCM_4.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn"
		;
connectAttr "line_6.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
connectAttr "line_7Shape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn";
connectAttr "ulna_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn";
connectAttr "radius_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn";
connectAttr "rt_forearm_fix_DCM_3.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn"
		;
connectAttr "ulnaEnd_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn";
