...
//Name: rtArmBp.ma
//Last modified: Thu, Apr 16, 2026 09:51:00 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2941E4FF-42C5-4F8F-E71C-119D5A4822CF";
createNode transform -s -n "persp";
	rename -uid "AB7E52E5-4BC6-549B-1229-4BA904DD5D93";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -85.48105985212149 186.58707458342892 33.933406685221044 ;
	setAttr ".r" -type "double3" -36.338352729798004 -46.600000000022739 2.3145193526666982e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 84.198158074591518;
...
createNode transform -n "master_guide";
	...
	setAttr ".t" -type "double3" -12 140 -1.7145055188062946e-14 ;
...
createNode nurbsCurve -n "line_01Shape" -p "line_01";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-4 140 -1.7145055188062946e-14
		-12.000000000000002 140 -1.6256876768362821e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_02Shape" -p "line_02";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12.000000000000002 140 -1.6256876768362821e-14
		-38.999999523162842 140 -1.8033233607763071e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_03Shape" -p "line_03";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-38.999999523162842 140 -1.8033233607763071e-14
		-65.999999046325684 140 -1.8033233607763071e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_04Shape" -p "line_04";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-65.999999046325684 140 -1.8033233607763071e-14
		-73.499999046325684 140 -4.6454943038167072e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_05Shape" -p "line_05";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-38.999999523162842 140 -1.8033233607763071e-14
		-38.999999523162799 140.00000000000003 -35.000000000000014
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_06Shape" -p "line_06";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-38.99999952316287 144 -1.8532478888919741e-14
		-65.999999046325684 140 3.9999999999999805
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-38.999999523162799 136 -1.756240083160309e-14
		-65.999999046325669 139.99999999999997 -4.0000000000000195
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape2" -p "line_09";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-11.999999999999993 145 -1.6869200167936496e-14
		0 145 4.9999999999999849
		;
	setAttr ".adot" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FD382741-4469-96BC-0063-7A958A528481";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C92ADADC-4AC4-A076-2FCD-0D858EE72D44";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D52A10D4-4B99-48B5-631E-3F8D95944BE3";
createNode displayLayerManager -n "layerManager";
	rename -uid "DA21D9DF-4A79-2586-534C-E8ACADCF10BF";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B019685E-4695-6F16-1724-B1A88637AC7B";
