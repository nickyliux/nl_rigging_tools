...
//Name: rtArmBp.ma
//Last modified: Fri, Jul 10, 2026 06:19:45 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "5C236274-44A1-5F59-6E15-99B0AAB4A6B6";
createNode transform -s -n "persp";
	rename -uid "AB7E52E5-4BC6-549B-1229-4BA904DD5D93";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -58.778738326583372 200.89766183282995 192.38781651266979 ;
	setAttr ".r" -type "double3" -27.338352729798284 -12.200000000023026 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 214.20561975078229;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -38.734448950401678 140 -12.716461634874733 ;
...
createNode transform -n "master_guide";
	...
	setAttr ".r" -type "double3" -1260 0 0 ;
...
createNode transform -n "clavicle_guide" -p "clavicle_guide_ofs";
	...
	setAttr ".ovc" 1;
	setAttr ".t" -type "double3" 5 2.9309887850104133e-14 9.0099225683078955e-32 ;
	setAttr -k off ".rx";
	setAttr -k off ".ry";
	setAttr -k off ".rz";
...
createNode nurbsCurve -n "line_01Shape" -p "line_01";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-4 138.99999999999997 -2.5125982237298545e-29
		-17 139 8.8434708570859006e-16
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_02Shape" -p "line_02";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-17 139 8.8434708570859006e-16
		-40.999999523162842 126.99977740290718 2.4999999999999889
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_03Shape" -p "line_03";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-40.999999523162842 126.99977740290718 2.4999999999999889
		-64.999999046325684 114.99955480581437 4.9999999999999787
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_04Shape" -p "line_04";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-64.999999046325684 114.99955480581437 4.9999999999999787
		-71.679251109250274 111.65986675874464 5.6957554370446761
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_05Shape" -p "line_05";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-40.999999523162842 126.99977740290718 2.4999999999999889
		-43.904114818974215 125.54781121258465 -32.349073280803253
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_06Shape" -p "line_06";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-42.788879475295097 130.57747338170611 2.500012052856778
		-64.668100155375782 115.16549379899406 8.9827512320917755
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-39.211119571030572 123.42208142410826 2.4999879471431989
		-65.331897937275556 114.83361581263466 1.017248767908177
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape2" -p "line_09";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-16.999999999999993 144 5.1744422167158617e-15
		-5 144 5.0000000000000071
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "313374E0-49DB-132C-5CBE-C8A8845E3CEF";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 1;
	setAttr ".ls" 2;
...
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|ulna_guide_ZRO|ulna_guide|ulna_guideShape" "radius_guide" ;
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|ulna_guide_ZRO|ulna_guide|ulna_guideShape" "ulnaEnd_guide" ;
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|ulna_guide_ZRO|ulna_guide|ulna_guideShape" "radiusEnd_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C1F54294-438A-F990-12FF-D19AE72A3AF7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7C383CD6-4B50-349A-3A41-F6AC71586122";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1E07A71F-4ED7-0EA3-E9E1-53924CEBEFFF";
createNode displayLayerManager -n "layerManager";
	rename -uid "6FD52F2B-4FDC-A86E-B4B9-02B26220C7BB";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "51E11304-47E6-FF05-0198-CBB080144075";
...
connectAttr "pv_planeShape.w" "plane_normal_loc_normalConstraint1.tg[0].tgm";
