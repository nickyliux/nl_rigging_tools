...
//Name: rtArmBp.ma
//Last modified: Thu, Apr 09, 2026 01:12:54 AM
//Codeset: 1252
requires maya "2027";
...
fileInfo "UUID" "7FFEC6E0-47C5-0B97-D05B-1C81D7D6C552";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -78.60080698495382 46.846520520998425 53.52832523163179 ;
	setAttr ".r" -type "double3" -34.538352729795733 -43.800000000021655 -4.4066638166590981e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 80.08183826502524;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "06A9D4CB-445A-98D4-94DD-8C8AB4B5E9C2";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AD607EE0-46F7-D458-8551-DDB0A054743E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5DB00303-4D0A-6366-780A-DEA4C7446988";
createNode displayLayerManager -n "layerManager";
	rename -uid "5029AE8C-4CE0-F9B5-5B89-5C8623915F41";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "86DA575B-451C-BE7E-D2A0-2A940A1E5A8F";
