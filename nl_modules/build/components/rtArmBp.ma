...
//Name: rtArmBp.ma
//Last modified: Sun, Nov 16, 2025 04:01:35 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A697834A-4DF9-CE11-3A5D-0DB71E40C932";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.9450245724491566 193.94797967213734 99.491348864053947 ;
	setAttr ".r" -type "double3" -24.338352729789953 21.399999999975758 -8.5401826272803261e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 126.77960766757153;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "42277A8B-4F31-2505-F279-168C1C9C92F2";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "467C10D1-464F-434C-90E7-88819AA7431B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8D852146-46ED-EC14-A392-838D949989E5";
createNode displayLayerManager -n "layerManager";
	rename -uid "D834F513-41C1-5B1C-D044-798596E80A36";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5A000179-461A-9333-9B27-008ED471B966";
