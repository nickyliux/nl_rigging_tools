...
//Name: rtArmBp.ma
//Last modified: Thu, Jan 22, 2026 06:44:38 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "3E2656B3-4C53-F0D9-C1D4-5FAD52425950";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 32.82952085997988 35.265297192335019 109.38901632691677 ;
	setAttr ".r" -type "double3" -24.338352729794906 24.199999999978377 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 115.84317361908299;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4616DDA2-439C-A24D-7E10-9E97E6723C82";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DD996DDB-4FAE-C662-81C0-65A520A650C4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "79D8FE23-4D26-F020-83BF-23B586E829E5";
createNode displayLayerManager -n "layerManager";
	rename -uid "947C50D9-449B-EB94-28FD-FFB76FA18B29";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1737C22D-4236-94BC-1D62-54BCFDFC100F";
