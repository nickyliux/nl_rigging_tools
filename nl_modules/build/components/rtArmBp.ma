...
//Name: rtArmBp.ma
//Last modified: Sat, Dec 13, 2025 01:09:49 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "4B4AC24F-41F5-5663-EA9F-21861575A89C";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 45.527028839333049 188.32433716260104 114.30531789854035 ;
	setAttr ".r" -type "double3" -20.738352729793355 29.399999999977396 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 152.52181424610916;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "11F1BF41-4DBD-DC03-E01D-2AA5F619055E";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "33D403F9-404E-C36C-6AB1-10ABEE950DF5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C9AFC3F2-4B64-38C0-FFD2-A796BB3A4B5F";
createNode displayLayerManager -n "layerManager";
	rename -uid "76EEDD17-4B1F-6522-71C3-4F9A4D76DF52";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E18AD66C-4C09-5D30-F758-0E8F67C0F483";
