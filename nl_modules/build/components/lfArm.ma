...
//Name: lfArm.ma
//Last modified: Sat, Jan 04, 2025 11:41:52 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A34177C6-43AF-1E91-08CF-3F9CE002A013";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 102.14832808047967 196.73414333570253 40.909583423632228 ;
	setAttr ".r" -type "double3" -36.938352729835813 51.40000000000849 5.0980264433069195e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 98.973312879732703;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 39.5 145 -15.879101046493089 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5BACB07A-46B8-4F2A-0EE8-C7BDD9460FC3";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7DA60C25-4888-AC6B-5568-E29E57B75A86";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E5FFC749-4F91-EC88-893C-59AA9B52854D";
createNode displayLayerManager -n "layerManager";
	rename -uid "DB8F6864-4DBD-3A5B-BCDC-D89F25E60037";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "554A245B-43E9-16E6-7EAF-CDA7EE86C0C2";
