...
//Name: lfArm.ma
//Last modified: Mon, Dec 09, 2024 10:46:33 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "4796AC38-4F38-F62D-0DB4-64AD1F7116BD";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 106.08960806930349 206.25288960467259 46.597276324777035 ;
	setAttr ".r" -type "double3" -38.138352729834843 52.600000000007832 2.6182755992674232e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 110.54819557992661;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7FF33BAD-4407-3B35-4764-A09DF95BD862";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "010963FC-422E-68AB-0854-00943BBB058C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "61611609-451E-A3F8-9D99-6A96C317FF87";
createNode displayLayerManager -n "layerManager";
	rename -uid "21B30682-498C-B1DA-6CDA-4EB979474BB3";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2B99B484-44F7-4842-901E-ACB45E130E6B";
