...
//Name: lfArm.ma
//Last modified: Wed, Jan 01, 2025 04:23:58 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2A7D633D-43E0-03CB-B005-A89500D5F7DC";
...
createNode transform -n "ball_guide_ofs" -p "palm_guide";
	...
	setAttr ".t" -type "double3" 7.9999999999999964 8.8817841970012523e-16 2.8421709430404007e-14 ;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.99255214485189 188.27793471404019 36.971734646246688 ;
	setAttr ".r" -type "double3" -33.338352729835727 53.400000000008369 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 89.958975250009303;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 39.5 145 -15.383767697947205 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DD58A241-4D33-2CD9-7DE5-A4BFC3FA5743";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6B053F0A-4B40-4470-0494-119A76A99078";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EE3659EB-4037-A073-F2FC-D680C4404508";
createNode displayLayerManager -n "layerManager";
	rename -uid "3E1ED6CC-46A4-7068-CC28-E78AFA00A527";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "43A83EE7-4FC6-B3D9-CC11-35BCDE663B72";
