...
//Name: lfArm.ma
//Last modified: Wed, Jan 08, 2025 12:39:25 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D808D74E-4FD8-0A92-A307-D983A88F86B1";
...
createNode nurbsCurve -n "clavicle_guideShape" -p "clavicle_guide";
	rename -uid "F199611C-4F9F-5B06-72DE-9D99CE135ED3";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 22;
...
createNode transform -n "tip_guide_ofs" -p "ball_guide_ofs";
	rename -uid "E559C140-4F1C-6C6C-F21F-BD905F5B055B";
	setAttr ".t" -type "double3" 8.0000000000000107 8.8817841970012523e-16 -1.4210854715202004e-14 ;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 109.85352846159022 175.19943630437749 21.011280707258745 ;
	setAttr ".r" -type "double3" -32.738352729835583 64.600000000009075 -1.1122502333500569e-14 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 46.248649490791301;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 81.5 145 -3.3333330162754748e-07 ;
...
parent -s -nc -r -add "|module_grp|master_guide|clavicle_guide_ofs|clavicle_guide|clavicle_guideShape" "palm_guide" ;
parent -s -nc -r -add "|module_grp|master_guide|clavicle_guide_ofs|clavicle_guide|clavicle_guideShape" "ball_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2D23C93E-4883-936B-9997-E8B25A4A0044";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D788A8DC-4FB3-C268-FECD-7BA8F4640EAC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "265384D1-4E16-F72C-27D6-7C9B72AA7CA7";
createNode displayLayerManager -n "layerManager";
	rename -uid "521C49CC-42F8-18BB-C3D5-B88FE537D641";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "59406674-402A-74ED-B11A-6C8230AF5745";
