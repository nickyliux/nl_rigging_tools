...
//Name: tail.ma
//Last modified: Sat, Apr 12, 2025 11:34:37 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "ECFE30BC-413F-9A67-43D7-86BFEFA81440";
createNode transform -s -n "persp";
	rename -uid "BEF4D478-470D-B96E-7F25-D6BB1F00F95C";
	setAttr ".t" -type "double3" 231.36464181355777 187.91385715692402 -194.58507579693705 ;
	setAttr ".r" -type "double3" -16.538352730944681 119.39999999999308 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CCC4238E-49DB-012B-6DB1-389ECA0FD5CF";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 255.93325592329111;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "78588C8D-4EF0-94E6-60E6-F489EACD2D98";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FA0D12C1-4FAF-60F6-B9C7-67AD927AA5BF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BEB8204C-4B30-516A-43F0-F4916C6B11BC";
createNode displayLayerManager -n "layerManager";
	rename -uid "4847007F-48F8-7751-B017-F4A62E7ADAC4";
createNode displayLayer -n "defaultLayer";
	rename -uid "030144B0-43CD-0617-1B9C-988179186839";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DA950D69-49D0-E036-C80F-078A1D951354";
