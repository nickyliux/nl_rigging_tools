...
//Name: lfLeg.ma
//Last modified: Sat, Apr 12, 2025 11:26:12 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "172EABD1-41E3-9DD5-226B-4E94064B8D74";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 131.23229273126475 90.930988264716731 108.51719157575086 ;
	setAttr ".r" -type "double3" -13.538352729768523 55.400000000012412 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 146.96670793622377;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BF12698E-4401-BB7B-7C34-DD8773C84E64";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "52A3391C-44B6-256D-CF6C-67A6395526B0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FF86A4B9-47BE-1114-4754-43A1321DAD89";
createNode displayLayerManager -n "layerManager";
	rename -uid "F5542A0C-42E9-EC22-60F2-B1BE000C8E4D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "044579F2-4D95-F865-1EA6-B29AC2C03895";
