...
//Name: lfLeg.ma
//Last modified: Mon, Dec 23, 2024 09:41:59 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D6E38688-49FE-7DE0-CE13-82BAF76FF233";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 102.30470399687844 75.001704039213067 104.36630556565815 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 118.20570895351815;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 14.999999999999993 54.24876833084565 27.396855321266976 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A50A65DB-4EBE-B111-8135-7BBECE431715";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7C599AB6-4D8A-AA6D-0123-D6BF0BCFF981";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7E404341-479B-DA4C-AC5F-23B2E9D78CC0";
createNode displayLayerManager -n "layerManager";
	rename -uid "43C8AF40-4457-6E1D-023F-36BB7FF5E4F7";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A4B20243-47D3-6916-26D5-32831C969E0C";
