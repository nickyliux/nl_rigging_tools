...
//Name: lfLeg.ma
//Last modified: Wed, Mar 12, 2025 04:14:07 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "619ADA46-4635-C17F-3DF4-678BA8000E54";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 140.60317366172222 65.75392150607378 117.70560226635088 ;
	setAttr ".r" -type "double3" -6.3383527298102695 45.800000000010584 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 155.14969388855155;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6EAC5993-434C-A2E9-7C2B-EC828CEDF685";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6F77B0B7-419C-6715-DC1B-05917DED611A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "63767652-4BB7-2100-8959-0AA28D3D7FDC";
createNode displayLayerManager -n "layerManager";
	rename -uid "D81E7252-464C-6060-8274-649075D855FA";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "60353D8A-4403-8F59-C2D6-ACB5123B2F22";
