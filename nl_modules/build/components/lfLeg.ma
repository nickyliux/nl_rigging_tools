...
//Name: lfLeg.ma
//Last modified: Thu, Feb 06, 2025 09:43:05 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "56FEBFB2-432E-332E-CAB9-3096915060A3";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 111.94992085581246 106.19367118247314 118.55876975907988 ;
	setAttr ".r" -type "double3" -20.738352729810078 47.400000000010287 0 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EA39746A-48C7-DA42-955F-F9AF51739ACE";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C178E21D-43FE-E36B-960A-6F98B7EBE9DE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9A964C2A-4C48-AD96-C1CA-15B78A9EE0CF";
createNode displayLayerManager -n "layerManager";
	rename -uid "19A5323E-4A50-51F7-4FE8-FD8EA53B7741";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0D436B68-4824-5207-56C5-2FA391B49FF3";
