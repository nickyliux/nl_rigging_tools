...
//Name: lfLeg.ma
//Last modified: Wed, Mar 26, 2025 12:17:07 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "E116FF5B-463D-DFB8-8139-E3AB5D2CA855";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 112.27433495903546 80.097281915365514 142.22492693310159 ;
	setAttr ".r" -type "double3" -10.538352729810288 38.600000000010645 5.0871263033265757e-16 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B5695C45-4FA3-2531-15DE-0BBE85C49996";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D06665DF-45CD-6E3C-0F50-DA921082BEF3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "64AEA76C-4D5C-0E6B-69B5-BD8FD380F2CA";
createNode displayLayerManager -n "layerManager";
	rename -uid "7D0FAF23-404E-B9A6-F2FC-CAA72A708B1D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "06BFBC24-4CB5-F044-F7F8-BDA99D836887";
