...
//Name: lfLeg.ma
//Last modified: Sat, Feb 22, 2025 10:01:04 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "0C454558-48A2-CD59-F9AC-E2AFE822BBB9";
...
createNode transform -n "master_guide" -p "module_grp";
	...
	addAttr -ci true -sn "______________" -ln "______________" -min 0 -max 0 -en " " -at "enum";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 126.57322775524716 91.661885770273017 106.80011866043722 ;
	setAttr ".r" -type "double3" -15.338352729810133 56.600000000010311 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 142.09251079892451;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "30426DCE-41D3-6A17-8096-D69E4F671661";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "13BEC819-43E7-5A7B-90A5-82BF32A1577A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A8B4DF88-4FF8-383F-F9B0-8CB38EE51089";
createNode displayLayerManager -n "layerManager";
	rename -uid "7026F244-4F81-E42F-87F6-F18E80762734";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EFA2A2B5-4C11-C880-D080-669E43B872C8";
