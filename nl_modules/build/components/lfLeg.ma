...
//Name: lfLeg.ma
//Last modified: Mon, Dec 09, 2024 10:46:07 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2406F56B-484C-B83D-A4A5-38879310468C";
...
createNode nurbsCurve -n "line_01Shape" -p "line_01";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		15 91.900000000000006 -1.0005336250607214e-18
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_02Shape" -p "line_02";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		15 91.900000000000006 -1.0005336250607214e-18
		15 49.800000000000004 1.9999999999999991
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		20 44.805632503576248 1.7627378861556435
		20 7.7000000000000002 1.499501285648742e-15
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_08Shape" -p "line_08";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		10 7.7000000000000002 -6.1332393319873705e-16
		10 44.805632503576248 1.7627378861556446
		;
	setAttr ".adot" yes;
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 107.12896570362145 77.863529441366069 129.05515300522364 ;
	setAttr ".r" -type "double3" -11.138352729809489 48.600000000009629 -1.2023656493398663e-15 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 138.32142797692467;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 14.999999999999993 54.000005833333276 27.148098657087885 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F89B4511-4B95-B362-0323-7E9D3CA1AD60";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C39B4BDD-406B-CCAB-D276-BF828C829335";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A76FFFF0-4E09-3F5A-B0C6-9B9899B908A2";
createNode displayLayerManager -n "layerManager";
	rename -uid "4297C432-43F3-40CF-417F-D79D2FAD23D4";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2A6E284B-480F-BA4C-381B-4F8A58E0E532";
