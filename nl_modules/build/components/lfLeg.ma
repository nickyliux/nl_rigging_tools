...
//Name: lfLeg.ma
//Last modified: Mon, Mar 31, 2025 03:20:17 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "8A23C78B-478C-8639-D3A3-17AD48BC9C4C";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 111.19007301633187 73.890247131779418 98.034602769792542 ;
	setAttr ".r" -type "double3" -8.1383527298111442 57.400000000011566 7.3791925294910108e-16 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 125.91055487014492;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2A521B3D-4960-CDEA-FAE7-6C8202258136";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "ACA66B53-4270-C8FA-8861-80B52D3B25BE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E7754F3E-4FE8-8474-4FB9-5BB7C69C4EAF";
createNode displayLayerManager -n "layerManager";
	rename -uid "5CCE3893-45EA-CE21-CF91-E49B995DE95D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "547A5453-4F64-F853-2F04-9DBD314EE8A4";
