...
//Name: lfHand.ma
//Last modified: Sat, Jan 04, 2025 11:14:59 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "0007337C-4AF5-4A0C-B6C9-9F944544EEB7";
...
createNode transform -n "ball_guide" -p "handJ_guide";
	rename -uid "9CCA945A-433F-8436-04BA-E79AB336E7A7";
	setAttr ".t" -type "double3" 12.5 0 0 ;
createNode nurbsCurve -n "ball_guideShape" -p "ball_guide";
	rename -uid "2A344024-4D18-3308-FD54-DD9CD15A9D43";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 22;
	setAttr ".cc" -type "nurbsCurve" 
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 102.69916865342955 170.76568044491336 17.389011692946731 ;
	setAttr ".r" -type "double3" -43.538352729828958 57.3999999999509 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 38.676339016994049;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B2424CFF-407F-73AE-E501-65AB9BF491F4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "57B9CFB6-4014-6F55-552D-1EB150F59D29";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6FCC9AD4-4114-54F1-DA71-069ECE19C7FA";
createNode displayLayerManager -n "layerManager";
	rename -uid "23E45DAF-4FEE-49C3-6293-34B2C2D8CF9D";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "219539F2-4273-3090-F405-29BC07283F0D";
