...
//Name: lfHand.ma
//Last modified: Wed, Jan 08, 2025 12:25:46 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "49A623A1-48D0-8921-CA13-BD87E59BA3A2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 104.74224244063211 173.08245062287213 20.159900605858375 ;
	setAttr ".r" -type "double3" -41.138352729828995 56.19999999995094 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 42.206582096333037;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "33F95E88-4DC2-84A3-2E12-7B8BC4EA20CE";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EAF7D780-4838-8942-5A30-AF8987B30062";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "71EE23F6-4495-BC56-5F05-03A42963E524";
createNode displayLayerManager -n "layerManager";
	rename -uid "CF09BB47-4AA7-87C7-89A7-D6AF9DB832F1";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0209D795-4E49-6788-6752-069A13F57307";
