...
//Name: lfHand.ma
//Last modified: Mon, Apr 14, 2025 04:03:31 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "3AD4B7D4-4672-9D9D-05DB-659047582F86";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 107.73094978162491 179.05249043327032 29.991169613688456 ;
	setAttr ".r" -type "double3" -39.938352729832616 50.199999999952709 7.4531475246028177e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 55.955180773213392;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "34361DD2-47E9-61A5-ACB9-108F45C52DA9";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6748C811-4E50-D874-7A4D-708FF90D2175";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "73DE38A8-4285-B604-655D-31B6D3B274B9";
createNode displayLayerManager -n "layerManager";
	rename -uid "62E65176-46DE-4759-0FC8-E09DC56364F7";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "901E913D-4574-6751-5E4B-90846574B3C0";
