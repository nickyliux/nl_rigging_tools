...
//Name: lfHand.ma
//Last modified: Thu, Dec 05, 2024 06:19:21 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "79BE8FC4-430C-CD31-EDC7-019CD75FF0FF";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 116.86927167230476 184.85296242560722 7.024467994015489 ;
	setAttr ".r" -type "double3" -46.538352729816324 85.399999999949316 -7.9316641913713292e-14 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 55.733552748893281;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0274B915-458B-DBF9-B6F7-399D5236586E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C14431FD-4843-1090-E1D4-3D9F798E312D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9DFF6780-4E66-A76F-EBCB-16A6560662C8";
createNode displayLayerManager -n "layerManager";
	rename -uid "DF548D9E-48CD-2CBC-3102-BFAB2B0E367F";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CE70452A-4A89-69FF-32AA-B8A9A04E5CB9";
