...
//Name: base.ma
//Last modified: Mon, Jun 09, 2025 09:11:43 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "6527C514-493F-E7E3-89DF-05AE07CCC1CE";
...
createNode nurbsCurve -n "master_ctlShapeOrig" -p "master_ctl";
	rename -uid "F44A125A-4F14-A3A6-9233-E9A0C920175E";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode nurbsCurve -n "master1_ctlShapeOrig" -p "master1_ctl";
	rename -uid "4D4B28DD-4C4F-287E-5559-93B7E5630FF9";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".gtag[0].gtagnm" -type "string" "cluster1";
	setAttr ".gtag[0].gtagcmp" -type "componentList" 1 "cv[0:7]";
...
createNode nurbsCurve -n "master2_ctlShapeOrig" -p "master2_ctl";
	rename -uid "53BF2495-440C-A8E1-AF4A-B8A4103020FB";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".gtag[0].gtagnm" -type "string" "cluster1";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -402.4189051459669 274.45534911799609 406.65960812030528 ;
	setAttr ".r" -type "double3" -25.538352730299593 -46.999999999997748 -4.6635811282184252e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 642.34008063236638;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 -2.3665827156630354e-30 2.7795641990540361 ;
...
createNode displayPoints -n "transform3Shape" -p "transform3";
	...
	setAttr -k off ".v";
	setAttr ".hio" yes;
createNode transform -n "scaleCluster";
	rename -uid "3A8D7C7E-4A44-1FFA-8B28-369BBE91933D";
	setAttr ".v" no;
createNode clusterHandle -n "scaleClusterShape" -p "scaleCluster";
	rename -uid "FFBBDD0B-4FFA-9864-52D9-DAB88E6E90AD";
	setAttr ".ihi" 0;
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "828B5D2F-4DD8-4E5B-8AB7-F19562E130D8";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "60F4E67B-45E3-1BCF-B4B3-C8A971A44838";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "26CB305F-4AE6-3F00-A6C6-22BBD447E6A7";
createNode displayLayerManager -n "layerManager";
	rename -uid "530BD28B-4BAE-6976-E665-319566EDEE78";
createNode displayLayer -n "defaultLayer";
	rename -uid "0EA9D9AE-4D1D-D355-DC25-0CBA922977DB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5EF8E007-4E09-FCC8-9D7E-3285FC90FFE6";
...
createNode cluster -n "scaleClusterCluster";
	rename -uid "EAC93432-4F5D-6846-6DB3-F28083E7B669";
	setAttr -s 3 ".ip";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "5DFE80B0-4ECE-3E7B-D480-A9BF8607B016";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -602.20463402657629 -655.36596967235289 ;
	setAttr ".tgi[0].vh" -type "double2" 641.27868694167614 -194.00772325383548 ;
	setAttr -s 5 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -360;
	setAttr ".tgi[0].ni[0].y" -600;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" -24.396928787231445;
	setAttr ".tgi[0].ni[1].y" -265.92202758789062;
	setAttr ".tgi[0].ni[1].nvs" 18305;
	setAttr ".tgi[0].ni[2].x" -360;
	setAttr ".tgi[0].ni[2].y" -465.71429443359375;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" -358.80218505859375;
	setAttr ".tgi[0].ni[3].y" -249.9364013671875;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" -872.85711669921875;
...
connectAttr "scaleClusterCluster.og[0]" "master_ctlShape.cr";
connectAttr "scaleClusterCluster.og[2]" "master1_ctlShape.cr";
connectAttr "scaleClusterCluster.og[1]" "master2_ctlShape.cr";
connectAttr "master2_ctl.size" "scaleCluster.sx";
connectAttr "master2_ctl.size" "scaleCluster.sy";
connectAttr "master2_ctl.size" "scaleCluster.sz";
...
connectAttr "master_ctlShapeOrig.ws" "scaleClusterCluster.ip[0].ig";
connectAttr "master2_ctlShapeOrig.ws" "scaleClusterCluster.ip[1].ig";
connectAttr "master1_ctlShapeOrig.ws" "scaleClusterCluster.ip[2].ig";
connectAttr "master_ctlShapeOrig.l" "scaleClusterCluster.orggeom[0]";
connectAttr "master2_ctlShapeOrig.l" "scaleClusterCluster.orggeom[1]";
connectAttr "master1_ctlShapeOrig.l" "scaleClusterCluster.orggeom[2]";
connectAttr "scaleCluster.wm" "scaleClusterCluster.ma";
connectAttr "scaleClusterShape.x" "scaleClusterCluster.x";
connectAttr "master2_ctlShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "scaleCluster.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "master2_ctlShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "master2_ctl.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
connectAttr "scaleClusterShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
