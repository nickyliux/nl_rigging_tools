...
//Name: rtLegBp.ma
//Last modified: Sat, Oct 11, 2025 12:16:31 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "062EAA35-44CD-21BF-A0EA-499518F672C7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 272.02369267094502 241.10172104125843 290.82938739072404 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C01A2CF8-49A7-0369-1F7A-77883CFD6F61";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1352A7CC-40CF-EFDA-0216-22817B1FB25B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B524C0E7-43F0-B7D6-C076-9AA3BC47045A";
createNode displayLayerManager -n "layerManager";
	rename -uid "841BEE1F-4CFC-25BD-93E8-98A2BAADD838";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "AE4B6E0F-4B52-45A3-9D68-29B361835C12";
