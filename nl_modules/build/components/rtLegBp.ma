...
//Name: rtLegBp.ma
//Last modified: Thu, Apr 09, 2026 04:12:20 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D5EA35B2-42BF-C639-09F5-E0A90324D1C7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 95.00365378018175 75.764623177585875 92.19113524554146 ;
	setAttr ".r" -type "double3" -12.338352729045523 44.600000000013395 1.11672694396929e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 161.69728634984489;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "09339167-4888-C91C-7773-1F8EDD227F79";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AD3DEC23-4479-DAF8-D64B-B19D3C76516B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "696E5563-45D8-EA3F-BB4B-D3A6890C33AA";
createNode displayLayerManager -n "layerManager";
	rename -uid "9C6AEAE7-439D-84D6-B64C-0D8CD9E0A70E";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CCA087ED-45A2-DC53-1043-6CA770D5D222";
