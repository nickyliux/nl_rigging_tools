...
//Name: rtLegBp.ma
//Last modified: Wed, Dec 17, 2025 05:46:02 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "C2FD8B46-4C7C-D1F7-AA6B-47835BA19827";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 210.73792708731523 136.68074352027529 291.69574591890637 ;
	setAttr ".r" -type "double3" -12.938352729040343 37.400000000010081 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 369.14273800599778;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "486178B4-4379-073E-9486-2EAD1BCE40DD";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B760027D-43E1-A716-B8BB-6D9CFA9756E8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DC5072A9-4D46-1434-6FE4-75A498669087";
createNode displayLayerManager -n "layerManager";
	rename -uid "4B6C5E4E-4729-3BA0-52A0-4786E56DE5E2";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4FEA8B72-41DA-0976-4830-7AB41FAFB792";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "022FB863-4E6D-7427-5316-55967C79A62A";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -452.00069819806868 -895.26732849587825 ;
	setAttr ".tgi[0].vh" -type "double2" 670.77245371051845 -58.046336393602886 ;
...
connectAttr "lwr_guide_ofs_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "lwr_guide_ofs_pointConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "lwr_guide_ofs.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
