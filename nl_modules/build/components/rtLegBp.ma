...
//Name: rtLegBp.ma
//Last modified: Thu, Sep 18, 2025 11:35:21 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "5B8298D0-413A-BEF0-9906-458515DC5FF2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 153.51842473621909 124.48278036025593 72.84765064679334 ;
	setAttr ".r" -type "double3" -26.138352729017036 71.800000000028305 -1.0183154341558932e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 192.72384913155099;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AB7D220D-4E6F-08F4-0D05-59894F36953A";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B9B172E3-4F09-408E-1904-38BBDCCC59F9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6DEA8ADD-4098-D63A-153C-34A43B294C13";
createNode displayLayerManager -n "layerManager";
	rename -uid "2B3E3CC1-4705-898E-B45E-769E4BC26862";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9BFE6975-4194-C510-6D1D-148654FD5A41";
