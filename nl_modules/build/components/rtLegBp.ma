...
//Name: rtLegBp.ma
//Last modified: Wed, Mar 11, 2026 12:17:14 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "694622D8-46AE-2354-FD57-C5AC0871EA60";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 107.83326047968163 111.08209976960792 149.20429848423359 ;
	setAttr ".r" -type "double3" -18.938352729043149 37.40000000001146 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FF5B1F16-4DF9-E1FF-FBBC-1C8393F472E3";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CF1DB8F2-4E2C-28EA-7BD1-709235498B47";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4E20555E-445C-3EFB-46AC-83BB43AC6C66";
createNode displayLayerManager -n "layerManager";
	rename -uid "F1A9836B-44EA-6378-76BD-82BFC3ABE47B";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "92531781-46A0-7B1B-9546-C2912B0EDED7";
