...
//Name: rtLegBp.ma
//Last modified: Thu, Jan 22, 2026 01:12:10 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "3EAB4D26-4019-4F2A-1508-BCB26C14F613";
...
createNode nurbsCurve -n "line_01Shape" -p "line_01";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		0 108 0
		0 91.900001525878906 1.9721522630525295e-31
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_02Shape" -p "line_02";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		0 91.900001525878906 1.9721522630525295e-31
		-1.3322676295501878e-15 49.800000667572021 -3.944304526105059e-31
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_03Shape" -p "line_03";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-1.3322676295501878e-15 49.800000667572021 -3.944304526105059e-31
		-9.8607613152626476e-32 7.6999998092651367 -1.9721522630525295e-31
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_04Shape" -p "line_04";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-9.8607613152626476e-32 7.6999998092651367 -1.9721522630525295e-31
		4.440892098500636e-16 3.8999999364217146 12.666667143503823
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_05Shape" -p "line_05";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		4.440892098500636e-16 3.8999999364217146 12.666667143503823
		-1.9721522630525291e-31 2 19.000000715255737
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_06Shape" -p "line_06";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-3.6726177654600173e-13 49.800000667572014 55
		-1.3322676295501878e-15 49.800000667572021 -3.944304526105059e-31
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape1" -p "line_09";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		3.9999999999999964 2.084363510755237 18.702699573070333
		4 2.8913130615306875 16.021499762816852
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape2" -p "line_10";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		4 2.8913130615306875 16.021499762816852
		3.9999999999999964 3.8999999999999999 12.67
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape3" -p "line_11";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		3.9999999999999964 3.8999999999999999 12.67
		4 6.2055701450727145 5.0094291135614846
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape4" -p "line_12";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		2 2.0843588365804591 18.702715103652778
		1.9999999999999929 2.4590139851547761 17.457872334606517
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape5" -p "line_13";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		1.9999999999999929 2.4590139851547761 17.457872334606517
		2 2.8913130615306875 16.021499762816852
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape6" -p "line_14";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		2 2.8913130615306875 16.021499762816852
		1.9999999999999964 3.8999999999999999 12.67
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape7" -p "line_15";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		1.9999999999999964 3.8999999999999999 12.67
		1.9999999999999996 6.2055701450727145 5.0094291135614828
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape8" -p "line_16";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-7.1054273576010019e-15 2.0843635107552365 18.702699573070337
		-7.1054273576010019e-15 2.4590186593295535 17.457856804024075
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape9" -p "line_17";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-7.1054273576010019e-15 2.4590186593295535 17.457856804024075
		0 2.8913130615306875 16.021499762816852
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape10" -p "line_18";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		0 2.8913130615306875 16.021499762816852
		-3.5527136788005009e-15 3.8999999999999999 12.67
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape11" -p "line_19";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-3.5527136788005009e-15 3.8999999999999999 12.67
		0 6.2055701450727145 5.0094291135614828
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape12" -p "line_20";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-2.0000000000000036 2.0843588365804591 18.702715103652778
		-2.0000000000000071 2.4590139851547761 17.457872334606517
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape14" -p "line_22";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-2 2.8913130615306875 16.021499762816852
		-2.0000000000000036 3.8999999999999999 12.67
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape16" -p "line_24";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-4.0000000000000036 2.0843588365804591 18.702715103652778
		-4.0000000000000071 2.4590139851547761 17.457872334606517
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape18" -p "line_26";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-4 2.8913130615306875 16.021499762816852
		-4.0000000000000036 3.8999999999999999 12.67
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		4.9999999999999982 44.800000000751986 2.6846203394220945e-08
		4.9999999999999982 7.6999998092651367 -1.3805065841367717e-30
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_08Shape" -p "line_08";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-5.0000000000000018 44.800000000751986 2.684620117502556e-08
		-4.9999999999999982 7.6999998092651367 6.1232339957367466e-16
		;
	setAttr ".adot" yes;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 183.27860570063461 142.60111228845415 200.68157686956877 ;
	setAttr ".r" -type "double3" -18.93835272904283 42.600000000010866 1.0802089619418368e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 273.69575813969004;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -8.8817841970012523e-15 54.017494394356305 17.407977340419393 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C2EE6427-4AEB-6FE7-6DC2-5CBDBE227B28";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "06006537-48C1-0BDF-878F-73979712113B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FC5B893E-44A3-0D0C-FDF5-D1B13F230317";
createNode displayLayerManager -n "layerManager";
	rename -uid "3F61B7F5-4634-48D5-7547-8B9E455198F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A9F7A037-4E0F-D268-ACE4-87AEBAA8AD21";
...
createNode condition -n "condition2";
	rename -uid "5DE1B0E6-4D89-805D-EB68-889EA55AAFBB";
	setAttr ".st" 2;
	setAttr ".ct" -type "float3" 1 0 0 ;
	setAttr ".cf" -type "float3" 0 1 1 ;
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "ECC99C0E-45E2-F575-B81C-998C60C93831";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -176.36874406261592 -1112.7289480200343 ;
	setAttr ".tgi[0].vh" -type "double2" 894.23395793084842 -314.41002243236437 ;
	setAttr -s 3 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 15.714285850524902;
	setAttr ".tgi[0].ni[0].y" -508.57144165039062;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 102.29949951171875;
	setAttr ".tgi[0].ni[1].y" -553.29937744140625;
	setAttr ".tgi[0].ni[1].nvs" 18306;
	setAttr ".tgi[0].ni[2].x" 607.6944580078125;
	setAttr ".tgi[0].ni[2].y" -968.74639892578125;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -1238.5615112446405 -393.4804653019072 ;
	setAttr ".tgi[1].vh" -type "double2" -59.592462894665921 485.64425783522444 ;
	setAttr -s 20 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -91.428573608398438;
	setAttr ".tgi[1].ni[0].y" -2.8571429252624512;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -398.57144165039062;
	setAttr ".tgi[1].ni[1].y" 342.85714721679688;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -398.57144165039062;
	setAttr ".tgi[1].ni[2].y" -2.8571429252624512;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 215.71427917480469;
	setAttr ".tgi[1].ni[3].y" -271.42855834960938;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 215.71427917480469;
	setAttr ".tgi[1].ni[4].y" -137.14285278320312;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -91.428573608398438;
	setAttr ".tgi[1].ni[5].y" 102.85713958740234;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -398.57144165039062;
	setAttr ".tgi[1].ni[6].y" 237.14285278320312;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -91.428573608398438;
	setAttr ".tgi[1].ni[7].y" 342.85714721679688;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" 215.71427917480469;
	setAttr ".tgi[1].ni[8].y" 290;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -398.57144165039062;
	setAttr ".tgi[1].ni[9].y" 102.85713958740234;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -91.428573608398438;
	setAttr ".tgi[1].ni[10].y" 237.14285278320312;
	setAttr ".tgi[1].ni[10].nvs" 18304;
	setAttr ".tgi[1].ni[11].x" 215.71427917480469;
	setAttr ".tgi[1].ni[11].y" 50;
	setAttr ".tgi[1].ni[11].nvs" 18304;
	setAttr ".tgi[1].ni[12].x" -1376.1778564453125;
	setAttr ".tgi[1].ni[12].y" 286.5362548828125;
	setAttr ".tgi[1].ni[12].nvs" 18306;
	setAttr ".tgi[1].ni[13].x" -1117.9345703125;
	setAttr ".tgi[1].ni[13].y" 291.2840576171875;
	setAttr ".tgi[1].ni[13].nvs" 18306;
	setAttr ".tgi[1].ni[14].x" -1032.89111328125;
	setAttr ".tgi[1].ni[14].y" 458.5714111328125;
	setAttr ".tgi[1].ni[14].nvs" 18304;
	setAttr ".tgi[1].ni[15].x" -353.74148559570312;
	setAttr ".tgi[1].ni[15].y" -156.42855834960938;
	setAttr ".tgi[1].ni[15].nvs" 18304;
	setAttr ".tgi[1].ni[16].x" -771.5609130859375;
	setAttr ".tgi[1].ni[16].y" 237.48312377929688;
	setAttr ".tgi[1].ni[16].nvs" 18304;
	setAttr ".tgi[1].ni[17].x" -722.817138671875;
	setAttr ".tgi[1].ni[17].y" 166.68235778808594;
	setAttr ".tgi[1].ni[17].nvs" 18304;
	setAttr ".tgi[1].ni[18].x" -837.57318115234375;
	setAttr ".tgi[1].ni[18].y" 306.55703735351562;
	setAttr ".tgi[1].ni[18].nvs" 18304;
	setAttr ".tgi[1].ni[19].x" -667.16595458984375;
	setAttr ".tgi[1].ni[19].y" 102.78898620605469;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "B7AF9560-4826-0394-B670-D7947AC6A8E1";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 711874.97171263013 -46713.25307990289 ;
	setAttr ".tgi[0].vh" -type "double2" 728328.54248739546 46256.110240925263 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -av -k on ".fzn";
...
connectAttr "condition2.ocr" "radius_guide_ZRO.v";
...
connectAttr "condition2.ocr" "ulna_guide_ZRO.v";
...
connectAttr "condition2.ocr" "radiusEnd_guide_ZRO.v";
...
connectAttr "condition2.ocr" "ulnaEnd_guide_ZRO.v";
...
connectAttr "condition2.ocr" "line_grp3.v";
...
connectAttr "master_guide.limbType" "condition2.ft";
...
connectAttr "DCM_11.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "radiusEnd_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
connectAttr "ulnaEnd_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "line_08.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "line_07.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "DCM_10.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "radius_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
connectAttr "DCM_9.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
connectAttr "line_07Shape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn";
connectAttr "ulna_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn";
connectAttr "DCM_8.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn";
connectAttr "line_08Shape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn";
connectAttr "master_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn";
connectAttr "condition2.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[13].dn";
connectAttr "foot_guideShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[14].dn"
		;
connectAttr "line_grp3.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[15].dn";
connectAttr "radius_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[16].dn"
		;
connectAttr "ulna_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[17].dn";
connectAttr "radiusEnd_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[18].dn"
		;
connectAttr "ulnaEnd_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[19].dn"
		;
connectAttr "refPlane.oc" "lambert3SG.ss";
connectAttr "|module_grp|fgrRef_grp|null5|fgrRef19|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null5|fgrRef18|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null5|fgrRef17|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null5|fgrRef16|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null4|fgrRef15|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null4|fgrRef14|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null4|fgrRef13|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null4|fgrRef12|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null3|fgrRef11|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null3|fgrRef10|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null3|fgrRef9|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null3|fgrRef8|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null2|fgrRef7|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null2|fgrRef6|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null2|fgrRef5|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null2|fgrRef4|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null1|fgrRef3|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null1|fgrRef2|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|module_grp|fgrRef_grp|null1|fgrRef1|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
