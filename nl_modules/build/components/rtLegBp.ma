...
//Name: rtLegBp.ma
//Last modified: Wed, Jun 24, 2026 02:51:56 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "00B98865-40D9-FF0D-6B67-93B01EECB0E2";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.2860705838990611 19.855257564340391 38.224545092933845 ;
	setAttr ".r" -type "double3" -30.338352729050253 27.800000000016439 -8.9888737452516784e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 41.892351506363696;
...
createNode transform -n "lwr_guide" -p "lwr_guide_ofs";
	...
	setAttr -l on -k off ".v";
	setAttr ".ovc" 1;
	setAttr ".t" -type "double3" 0 1.7763568394002505e-15 -8.8817841970012582e-16 ;
	setAttr -k off ".rx";
	setAttr -k off ".ry";
	setAttr -k off ".rz";
	setAttr -l on -k off ".sx";
...
createNode transform -n "toesRoot_guide" -p "palm_guide";
	...
	setAttr -l on -k off ".sy";
	setAttr -l on -k off ".sz";
	setAttr ".rp" -type "double3" 0 -4.4408920985006271e-16 8.8817841970012523e-16 ;
...
createNode transform -n "pvc_guide_ofs" -p "pv_loc";
	...
	setAttr ".t" -type "double3" -3.819167204710538e-13 7.1054273576010003e-15 60 ;
...
createNode nurbsCurve -n "toe02_2_guideShape" -p "toe00_2_guide";
	rename -uid "56432C30-49BC-D181-9529-C39CF8125619";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 20;
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		58
		0.15741653748833584 -0.0010704445205455542 -6.2864225933857744e-09
		0.14584355713531566 0.059251710344982889 -6.2864225933857744e-09
		0.11206719028557931 0.11055329186321704 -6.2864225933857744e-09
		0.061229776731453432 0.14502406495600936 -6.2864225933857744e-09
		0.0010704023330471912 0.1574163265508367 -6.2864225933857744e-09
		-0.059251499407483782 0.14584334619781653 -6.2864225933857744e-09
		-0.1105531863944669 0.11206708481682913 -6.2864225933857744e-09
		-0.14502395948725916 0.061229565793954346 -6.2864225933857744e-09
		-0.15741632655083548 0.0010704550674204495 -6.2864225933857744e-09
		-0.1458433461978153 -0.059251710344982889 -6.2864225933857744e-09
		-0.11206697934807897 -0.11055329186321704 -6.2864225933857744e-09
		-0.061229565793953125 -0.14502406495600936 -6.2864225933857744e-09
		1.214306433183765e-15 -0.1574163265508367 0
		0.05925171034498411 -0.14584334619781653 -6.2864225933857744e-09
		0.11055339733196723 -0.11206708481682913 -6.2864225933857744e-09
		0.14502417042475943 -0.061229565793954346 -6.2864225933857744e-09
		0.15741653748833584 -0.0010704445205455542 -6.2864225933857744e-09
		0.14543391651441206 -0.00098895936511040629 -0.060242061897579365
		0.11131034654314775 -0.0007569154611808454 -0.11131277232437226
		0.060240690803844303 -0.00040963640215363603 -0.14543708057687912
		1.214306433183765e-15 0 -0.15742001795704977
		-0.060240479866343989 0.00040965116777848829 -0.14543708057687912
		-0.11131024107439635 0.00075693022680569776 -0.11131277232437226
		-0.14543370557691174 0.00098897413073525888 -0.060242061897579365
		-0.15741632655083548 0.0010704550674204495 -6.2864225933857744e-09
		-0.14543370557691174 0.00098897413073525888 0.060242061897579365
		-0.11131024107439635 0.00075693022680569776 0.11131277232437226
		-0.060240479866343989 0.00040965116777848829 0.14543708057687912
		1.214306433183765e-15 7.4584440660405588e-09 0.15742001795704977
		0.060240690803844303 -0.00040963640215363603 0.14543708057687912
		0.11131034654314775 -0.0007569154611808454 0.11131277232437226
		0.14543391651441206 -0.00098895936511040629 0.060242061897579365
		0.15741653748833584 -0.0010704445205455542 -6.2864225933857744e-09
		...
		0.060240690803844303 -0.00040963640215363603 -0.14543708057687912
		1.214306433183765e-15 0 -0.15742001795704977
		1.214306433183765e-15 0.06054169861333298 -0.146160596194644
		1.214306433183765e-15 0.11186648325633515 -0.11186648325633515
		1.214306433183765e-15 0.146160596194644 -0.06054169861333298
		0.0010704023330471912 0.1574163265508367 -6.2864225933857744e-09
		1.214306433183765e-15 0.146160596194644 0.06054169861333298
		1.214306433183765e-15 0.11186648325633515 0.11186648325633515
		1.214306433183765e-15 0.06054169861333298 0.146160596194644
		...
		1.214306433183765e-15 -0.06054169861333298 -0.146160596194644
		1.214306433183765e-15 0 -0.15742001795704977
		1.214306433183765e-15 0 -1.265625
		1.214306433183765e-15 0 -1.1711366400095347e-08
		1.214306433183765e-15 -0.6328125 0
		1.214306433183765e-15 0 1.1711366400095347e-08
		1.214306433183765e-15 0 1.1711366400095347e-08
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-10.000000000000002 44.800000000751986 2.6846203394220945e-08
...
createNode scaleConstraint -n "null5_scaleConstraint1" -p "null5";
	...
	setAttr -av ".tg[0].tw";
	setAttr -k on ".w0";
createNode transform -n "pole_normal_grp" -p "master_guide";
	rename -uid "863ADEFE-4E57-FED9-C157-13A30730F73F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15 0 0 ;
createNode transform -n "pv_plane" -p "pole_normal_grp";
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "B07809F7-4C5F-970B-3E6D-4C905729EAF2";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 1;
	setAttr ".ls" 2;
...
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|patella_guide|radius_guideShape" "radius_guide" ;
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|patella_guide|radius_guideShape" "radiusEnd_guide" ;
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|patella_guide|radius_guideShape" "ulnaEnd_guide" ;
parent -s -nc -r -add "|master_guide|lwr_guide_ofs|lwr_guide|patella_guide|radius_guideShape" "ulna_guide" ;
...
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe03_1_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe01_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe04_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe03_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe02_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe03_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe03_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe04_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe00_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe01_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe02_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe01_4_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe02_5_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe04_3_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe01_1_guide" ;
parent -s -nc -r -add "|master_guide|toe_guide_grp|toe00_2_guide_ofs|toe00_2_guide|toe00_3_guide_ofs|toe00_3_guide|toe03_1_guideShape" "toe02_1_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C0C256F3-4B53-8D71-EA61-7B88CABD4CB3";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "35B8D429-443B-4F1B-089C-72BF5B993CA7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B72C1949-4D10-E753-CC5D-079A0F3E5DC8";
createNode displayLayerManager -n "layerManager";
	rename -uid "8A4CEDAC-46AB-3FAD-2F0B-52A839F9E3DE";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2C259DCB-451E-0894-C4DB-B1B92B772579";
...
createNode lambert -n "refPlane";
	rename -uid "FC7251D3-4950-BBEC-6DF0-429EF2660D27";
	setAttr ".c" -type "float3" 1 0 0 ;
createNode shadingEngine -n "lambert3SG";
	rename -uid "8CA0C821-46B4-4E07-6CE2-4089091B960E";
	setAttr ".ihi" 0;
	setAttr -s 19 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "8AF8BF16-446B-B794-5E57-4091F2329DB5";
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "3E85E58C-4ACD-B8A5-F2B7-9FB1E779B4B7";
...
connectAttr "deleteComponent1.og" "pv_planeShape1Orig.i";
...
connectAttr "pv_planeShape.w" "pole_normal_loc_normalConstraint1.tg[0].tgm";
...
connectAttr "|master_guide|fgrRef_grp|null5|fgrRef19|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null5|fgrRef18|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null5|fgrRef17|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null5|fgrRef16|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null4|fgrRef15|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null4|fgrRef14|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null4|fgrRef13|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null4|fgrRef12|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
...
connectAttr "|master_guide|fgrRef_grp|null3|fgrRef8|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null2|fgrRef7|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null2|fgrRef6|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null2|fgrRef5|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null2|fgrRef4|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null1|fgrRef3|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null1|fgrRef2|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
connectAttr "|master_guide|fgrRef_grp|null1|fgrRef1|fgrRefShape.iog" "lambert3SG.dsm"
		 -na;
