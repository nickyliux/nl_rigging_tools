...
//Name: rtLegBp.ma
//Last modified: Fri, Sep 19, 2025 12:48:06 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A338C872-4523-B790-8EA8-0BB8CEBE792D";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 159.9926263554064 115.98633998271004 144.53506185838154 ;
	setAttr ".r" -type "double3" -15.938352729017103 53.40000000002842 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 225.6988069485285;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BA8C1E8B-4958-79B2-C85C-7F86A5854AFB";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "94714F7C-4D27-65F1-D65F-36B26AC063A1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8AB0F279-4D16-DD64-9901-BB910C183B73";
createNode displayLayerManager -n "layerManager";
	rename -uid "5DF4D28D-447B-C3AB-BCCB-F8A7DF7E14AB";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D007F675-474C-4338-BA8E-2BB0D26C533E";
