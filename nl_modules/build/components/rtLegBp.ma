...
//Name: rtLegBp.ma
//Last modified: Wed, Aug 27, 2025 05:44:03 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "13A2390B-4BA9-EB6C-28A8-EA9E2D09D8B0";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 70.265984297374715 80.515626505294165 115.1224917096867 ;
	setAttr ".r" -type "double3" -10.538352729016321 47.800000000026472 1.1837342535051423e-15 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2DB9CD64-4125-751B-765A-F4943D0ED1A7";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A6DB9469-47FB-402A-AFD7-0A959D6FA6B0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FD77131E-43E4-1522-75DD-C8BFA95E61D4";
createNode displayLayerManager -n "layerManager";
	rename -uid "472FDF8B-4FC0-7DAB-6CD5-46BBA17C03F9";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "377DD854-4C93-68FC-C7C0-E6B5F644E34B";
