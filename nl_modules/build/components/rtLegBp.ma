...
//Name: rtLegBp.ma
//Last modified: Sat, Dec 13, 2025 01:10:13 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "9F1FD403-423B-C62E-9E30-2DBB61A2E35B";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "09E2C826-465A-3C65-1BA9-E8BC0BADFBD7";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F3120421-40A7-D8FC-F2D2-D1AD5DD87877";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B2ED3187-4173-1EF9-0D29-118F909B2CDE";
createNode displayLayerManager -n "layerManager";
	rename -uid "17A7B4A0-4584-2E6E-A325-BD9A2EDD3219";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BCF461BC-4609-E8B5-D1BD-AB995B3016AC";
