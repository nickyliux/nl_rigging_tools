...
//Name: rtLegBp.ma
//Last modified: Wed, Aug 20, 2025 04:37:20 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "C50528E6-4D15-7844-D73A-1583B054B1C7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.2660789620840129 20.097511302415935 32.967711705511647 ;
	setAttr ".r" -type "double3" -34.538352729011983 31.800000000024784 1.8711507392107493e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 38.81466348771616;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7D78106F-4E01-177D-E418-D587E74A56C0";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7FC271E5-4411-9AE8-6174-4BAC05DD6135";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EA0A5613-4B4D-0B02-02EE-26A109E5400B";
createNode displayLayerManager -n "layerManager";
	rename -uid "1755D0F4-4A4C-FB4F-7B62-66B408F08BDB";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "49EB586F-4F8F-529C-0678-4D88EC1FED3E";
