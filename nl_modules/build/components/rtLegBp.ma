...
//Name: rtLegBp.ma
//Last modified: Thu, Apr 16, 2026 09:51:55 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "4858DF4F-41FD-4D6B-C604-9EAD8FFDAEDE";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 51.007951090109522 95.12340600312443 103.64735322683926 ;
	setAttr ".r" -type "double3" -17.738352729046003 43.800000000013988 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 148.30033349847236;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -8.8817841970012523e-15 1.4791141972893971e-31 7.526561013868557 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B5731A6E-4929-EF72-765F-6CBA812C165A";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "54225A09-4DA8-014A-D372-80A8681D13E6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C3726955-43FC-1FEA-F9A4-6DAE95878F40";
createNode displayLayerManager -n "layerManager";
	rename -uid "6E619B48-4CEA-C216-0D2D-08A4C8658210";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BFD4CE59-491F-64A4-EF15-E4BF73C35D52";
