...
//Name: rtLegBp.ma
//Last modified: Mon, Sep 15, 2025 12:06:24 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D499081F-416E-CDB1-D546-EBAF618CFE9B";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 219.31013197214358 108.53628984838275 305.72968461884921 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AC2C8564-4BFF-8357-1BA4-D787F944437E";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B1FABB0B-4873-754D-332C-DE816EE06AAB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "11D96C02-4B50-66B5-27C3-649BCAB26C88";
createNode displayLayerManager -n "layerManager";
	rename -uid "214A92B3-4897-641F-34CC-CEA45CEEDAD4";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4B7CFA1B-424D-44F2-FE5F-6C89658486C2";
