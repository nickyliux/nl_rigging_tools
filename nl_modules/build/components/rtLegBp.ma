...
//Name: rtLegBp.ma
//Last modified: Tue, Jun 30, 2026 12:11:59 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "D8313A09-4FCF-0709-2DA5-F0B2A6BAB8A9";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 61.441780483463617 123.02193557761542 141.38362509225141 ;
	setAttr ".r" -type "double3" -24.33835272905042 43.800000000016588 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 160.52986332087633;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DFF787E9-4DC9-908F-8B9E-A79AC7E8D118";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EBCC9040-48B1-B45E-2D5B-BD884FD67F67";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "60971C41-49AF-DCA9-59A6-57908FCA8C9E";
createNode displayLayerManager -n "layerManager";
	rename -uid "2A74EDB1-413F-6149-2315-E8A84910DC8F";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E0DF8581-4B0C-66B9-EABA-3E8A4AEBD1D4";
