...
//Name: rtLegBp.ma
//Last modified: Fri, Jul 25, 2025 01:04:10 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "DF9771F9-4F80-B87B-F026-DE9BFF2251F8";
...
createNode transform -n "toe_main_1_guide" -p "toe_main_1_guide_ofs";
	...
	setAttr ".t" -type "double3" 3.5527136788005009e-15 -6.5 0 ;
...
createNode transform -n "toe_main_3_guide" -p "toe_main_3_guide_ofs";
	...
	setAttr ".t" -type "double3" 3.5527136788005009e-15 -2.8 0 ;
...
createNode transform -n "toe00_4_guide" -p "toe00_4_guide_ofs";
	...
	setAttr ".t" -type "double3" 1.7763568394002505e-15 0 9.0150739132302553e-17 ;
...
createNode nurbsCurve -n "curveShape1" -p "line_09";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-10.999999999999998 2.0274572453173336 18.577308217439345
		-10.999999999999996 2.7999997312547023 16.199666926701461
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape2" -p "line_10";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10.999999999999996 2.7999997312547023 16.199666926701461
		-11 3.8999997312547028 12.666334070205282
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape3" -p "line_11";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-11 3.8999997312547028 12.666334070205282
		-10.999999999999996 6.4999997312547029 3.9996669267014591
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape4" -p "line_12";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-12.999999999999998 1.9983805770302254 18.936056616605853
		-13.000000000000004 2.4001026697176568 17.699683145422153
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape5" -p "line_13";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-13.000000000000004 2.4001026697176568 17.699683145422153
		-12.999999999999996 2.7999997312547023 16.199666926701461
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape6" -p "line_14";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12.999999999999996 2.7999997312547023 16.199666926701461
		-13 3.8999997312547028 12.666334070205282
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape7" -p "line_15";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-13 3.8999997312547028 12.666334070205282
		-12.999999999999996 6.4999997312547029 3.9996669267014591
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape8" -p "line_16";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-15.000000000000005 1.9982779073125707 18.9363734711837
		-15.000000000000004 2.4000000000000021 17.699999999999999
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape9" -p "line_17";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-15.000000000000004 2.4000000000000021 17.699999999999999
		-14.999999999999996 2.8000000000000016 16.199999999999999
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape10" -p "line_18";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14.999999999999996 2.8000000000000016 16.199999999999999
		-15 3.9000000000000012 12.666667143503823
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape11" -p "line_19";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-15 3.9000000000000012 12.666667143503823
		-14.999999999999996 6.5000000000000009 3.9999999999999991
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape12" -p "line_20";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-16.999999999999996 1.9983805770302254 18.936056616605853
		-17.000000000000004 2.4001026697176568 17.699683145422153
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape13" -p "line_21";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-17.000000000000004 2.4001026697176568 17.699683145422153
		-16.999999999999996 2.7999997312547023 16.199666926701461
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape14" -p "line_22";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-16.999999999999996 2.7999997312547023 16.199666926701461
		-17 3.8999997312547028 12.666334070205282
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape15" -p "line_23";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-17 3.8999997312547028 12.666334070205282
		-16.999999999999996 6.4999997312547029 3.9996669267014591
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape16" -p "line_24";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-18.999999999999996 1.9983805770302254 18.936056616605853
		-19.000000000000004 2.4001026697176568 17.699683145422153
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape17" -p "line_25";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-19.000000000000004 2.4001026697176568 17.699683145422153
		-18.999999999999996 2.7999997312547023 16.199666926701461
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape18" -p "line_26";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-18.999999999999996 2.7999997312547023 16.199666926701461
		-19 3.8999997312547028 12.666334070205282
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "curveShape19" -p "line_27";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-19 3.8999997312547028 12.666334070205282
		-18.999999999999996 6.4999997312547029 3.9996669267014591
		;
	setAttr ".adot" yes;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 38.634904134723328 97.361359305245202 61.539758765222736 ;
	setAttr ".r" -type "double3" -27.338352728974488 43.800000000009383 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 106.12785186307624;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -15.000000000000007 1.4791141972893971e-31 10.472990513868556 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FE8FED3E-46EA-1671-A369-639BC405F823";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2F38D28C-4919-2AFF-3FE4-A5970BD1298D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "67B9E2D9-4899-23BB-9BF0-0DAB76008B7E";
createNode displayLayerManager -n "layerManager";
	rename -uid "99CE26FD-4783-7CBC-4A21-D3AC4D6AB0B2";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "409C6F2D-4679-B0BB-B2C9-BDAC78BCF22C";
