...
//Name: rtLegBp.ma
//Last modified: Tue, Mar 10, 2026 02:52:33 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "1B1B6E3D-4AA6-D6F8-709D-B5BFAFE7205F";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 135.7195322655374 96.401355336305727 150.44378767893164 ;
	setAttr ".r" -type "double3" -12.938352729043167 44.200000000011308 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 207.48009905570876;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E9E0805F-4987-A503-469B-69BF2B85D1C6";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "668768F8-4E76-DCFC-D990-58BB118B4C6F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6572C762-4769-3211-C37D-C7BA0AE9D851";
createNode displayLayerManager -n "layerManager";
	rename -uid "D91B7EB8-4845-0AE2-BAAF-3B85EA96EA1D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A018C0CD-4624-77E2-585F-72A8C451E710";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "FE87BBFA-4F40-3ABF-8B8E-00A5A0D0C69A";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1119.0017870366962 -1115.4761461511509 ;
	setAttr ".tgi[0].vh" -type "double2" 1839.2398536551004 -314.2857017971225 ;
	...
	setAttr ".tgi[1].vl" -type "double2" -1468.7421311461439 -1249.9352313003744 ;
	setAttr ".tgi[1].vh" -type "double2" -614.38456703820782 -797.82824445811116 ;
	setAttr -s 3 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -957.18170166015625;
	setAttr ".tgi[1].ni[0].y" -924.26739501953125;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" -1495.8734130859375;
	setAttr ".tgi[1].ni[1].y" -154.36048889160156;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -1274.44482421875;
	setAttr ".tgi[1].ni[2].y" -154.36048889160156;
...
connectAttr "fgrRef_grp.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "foot_guideShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "master_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
