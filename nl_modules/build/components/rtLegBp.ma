...
//Name: rtLegBp.ma
//Last modified: Tue, Jun 10, 2025 01:56:22 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "6136D632-4D68-8D89-7D78-2490B8724BB8";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 72.498238071030556 53.786758495966552 43.997409805292172 ;
	setAttr ".r" -type "double3" -28.538352728962639 73.400000000006102 -1.1132951300590072e-14 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 114.58649400377116;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "81F7B5DD-4F35-5CE7-FEF0-B1A43162145F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "22F8DCC8-403A-9EAB-8E07-78A6EB87B717";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9795A60C-4E6C-C4E1-7A28-DFA31AAEAD06";
createNode displayLayerManager -n "layerManager";
	rename -uid "7328A345-4E85-807B-081D-2BB8FE682DAD";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B2597D9F-4084-4038-93DF-C09E65C168BC";
