...
//Name: rtLegBp.ma
//Last modified: Tue, Aug 26, 2025 10:55:41 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "0C8007CF-40CC-7907-F432-83A15EADB43D";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 80.074616394032716 67.73515413858523 107.84460072818349 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "29B62CB4-484E-3483-A813-5CB6BBFF636D";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7F8E04F9-4BDA-7FEB-F01D-65955537F66B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C016AA56-4D2B-0E75-4C22-2B8E56DA0C2C";
createNode displayLayerManager -n "layerManager";
	rename -uid "39FB0B66-42FC-FF1D-B84C-9AAF58232EF2";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0C1C2FF7-4642-A23B-D471-5C8BFDCA9470";
