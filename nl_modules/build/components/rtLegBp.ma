...
//Name: rtLegBp.ma
//Last modified: Fri, Jul 10, 2026 05:48:27 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A5E3E7DE-45D3-184B-5512-E5945E46FDEF";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 113.90277131001947 100.72299979569915 127.41680939657743 ;
	setAttr ".r" -type "double3" -17.138352729058191 39.400000000021592 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 204.22264260253746;
...
createNode nurbsCurve -n "toe02_2_guideShape" -p "toe00_2_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		4.6768144912334719e-15 0.06054169861333298 -0.146160596194644
		4.6768144912334719e-15 0 -0.15742001795704977
		4.6768144912334719e-15 0 -0.6328125
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6E93ED78-401C-C27D-29B5-C4B536740E91";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9B66BB2C-4985-9F71-8A7A-B096AF6922D7";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F0EAF757-4247-2C1B-A58A-A293A0213CBD";
createNode displayLayerManager -n "layerManager";
	rename -uid "F158FE60-4108-A4C2-979E-A9A9FC6CAD8D";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "66C47D5C-4964-ED4D-E786-29855D3AB1FC";
