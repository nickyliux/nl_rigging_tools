...
//Name: rtLegBp.ma
//Last modified: Wed, Apr 08, 2026 01:34:04 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A7A1418B-4423-9DC7-5533-CABC9EE061D8";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 129.70186793873228 106.86909988316512 132.02841236377486 ;
	setAttr ".r" -type "double3" -18.33835272904323 45.400000000011545 -1.1324292716156858e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 194.48796798503844;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BE476051-4A37-6C3C-C7A1-7F91AEFD68E2";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "55931674-4FC9-53E7-C18D-7790D3106F43";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8394CECC-4012-B7A2-1734-3ABE05D10823";
createNode displayLayerManager -n "layerManager";
	rename -uid "B47F61B6-4DB3-5ED0-C1EA-55BE8AAB9ACB";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C5698ABF-462F-50BF-3290-2BB4E341184A";
