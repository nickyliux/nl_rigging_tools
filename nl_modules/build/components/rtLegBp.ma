...
//Name: rtLegBp.ma
//Last modified: Fri, Aug 22, 2025 01:56:54 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "13B08A2E-4B54-163A-284E-7FBDCCE77FDC";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.0929761014480386 15.124601917624748 29.772041667464066 ;
	setAttr ".r" -type "double3" -38.138352729016013 26.60000000002626 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.206648480058931;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "47876DF4-46AE-B637-254D-D99CB884A7A3";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3C2244B1-4382-9175-0810-24B7B7CD3FCD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "34E82801-491B-3397-F337-DC9A018938A6";
createNode displayLayerManager -n "layerManager";
	rename -uid "D0BDECDE-4ADF-EA2B-EAA9-309DDA6587BB";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0F4A52B0-4F3F-E2AE-6230-DC8B53561E57";
