...
//Name: rtLegBp.ma
//Last modified: Mon, Sep 15, 2025 06:35:34 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "7985DDB5-4B6E-A7BC-1905-D59BB8DC8E1B";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 225.75786335822988 108.16966950304717 300.72752802132476 ;
	setAttr ".r" -type "double3" -8.7383527290163947 38.200000000026577 -5.0590551363191757e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 369.27733998942199;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -15.000000000000007 54.017494394356305 25.354406840419394 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EB6C74F1-4841-5D23-86D9-1C9E791001F8";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "162D777D-4FD1-FF01-6768-898906FB05BF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4A1E129E-4F75-BA8E-59B0-9385C68A99DD";
createNode displayLayerManager -n "layerManager";
	rename -uid "F45B7BF5-41B2-3AD1-FC79-19AF73589C60";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1F6D130F-4E4F-D848-11A2-CE91A82C8F59";
