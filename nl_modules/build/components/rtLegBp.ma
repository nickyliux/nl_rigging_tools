...
//Name: rtLegBp.ma
//Last modified: Sat, Apr 25, 2026 10:50:43 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "86DD1F06-40AD-7B15-C36A-D0835BBCB974";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 77.068739738312587 169.18745863396154 243.44123696821399 ;
	setAttr ".r" -type "double3" -23.738352729046284 15.400000000014277 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 283.13193890917478;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -15.000000000000007 54.017494394356305 17.407977340419393 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1B1617A3-46D4-10D9-4803-B5BC34321CAE";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "890E573F-42A9-33D5-1820-DBB18FA3E764";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DF322A70-4B52-E30E-1143-F7815CB50B87";
createNode displayLayerManager -n "layerManager";
	rename -uid "E97AB401-4971-07F9-3239-EBB32BDFDEA1";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D094F2E8-41A6-10E9-8AA2-76B895AC2B56";
