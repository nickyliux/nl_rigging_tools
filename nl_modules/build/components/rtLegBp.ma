...
//Name: rtLegBp.ma
//Last modified: Tue, Oct 07, 2025 04:45:46 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "83FC8E49-4AB2-5066-A872-D3B666EC546C";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 362.36572477440762 237.24806948498826 326.45691826184651 ;
	setAttr ".r" -type "double3" -20.138352729039486 45.000000000009258 1.1244958915989181e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 532.15386408791437;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A45F60C2-4B73-C010-F3E1-F495CF7DE2B1";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5124322A-4266-C215-CF0E-AF9CA57DC2EE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "96182F57-46D5-4EA3-C767-ADA5DC209CBD";
createNode displayLayerManager -n "layerManager";
	rename -uid "452DA61E-4DEA-4056-753C-ED8E12A014E5";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BB5255F3-48FE-5D6A-8A4F-72A5447F475B";
