...
//Name: rtLegBp.ma
//Last modified: Mon, Sep 08, 2025 03:44:20 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "C1B8FF41-4548-24D7-CAC9-8096318F7118";
...
createNode transform -n "master_guide" -p "module_grp";
	...
	addAttr -ci true -sn "rollFix" -ln "rollFix" -min 0 -max 1 -at "bool";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 83.624591545512601 57.944374909134389 114.51132113831085 ;
	setAttr ".r" -type "double3" -5.1383527290164075 40.600000000026526 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 168.04760135588202;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4DBD1CBE-454D-2C9E-1B13-E2A8D0EA2372";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8EE2BF29-4481-0573-EF93-D9BEBE4D2279";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B06DDD53-4F82-F5E4-CD0B-F4BED0DF5D73";
createNode displayLayerManager -n "layerManager";
	rename -uid "915590B0-4B71-A0CD-6053-439C04E99CC1";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F2E568DE-4316-AF5E-698E-25A06158D4C8";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "11515326-4702-0B61-D306-E7A4492A79B6";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 272.64228827331192 -1265.4761401906867 ;
	setAttr ".tgi[0].vh" -type "double2" 1828.5481044233602 -114.28570974440838 ;
	setAttr -s 9 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 771.09979248046875;
	setAttr ".tgi[0].ni[0].y" -319.30343627929688;
	setAttr ".tgi[0].ni[0].nvs" 18306;
	setAttr ".tgi[0].ni[1].x" 1031.72119140625;
	setAttr ".tgi[0].ni[1].y" -401.37033081054688;
	setAttr ".tgi[0].ni[1].nvs" 18305;
	setAttr ".tgi[0].ni[2].x" 1.4285714626312256;
	setAttr ".tgi[0].ni[2].y" 374.28570556640625;
	setAttr ".tgi[0].ni[2].nvs" 18306;
	setAttr ".tgi[0].ni[3].x" 1031.72119140625;
	setAttr ".tgi[0].ni[3].y" -507.0845947265625;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" -201.92164611816406;
	setAttr ".tgi[0].ni[4].y" -695.245849609375;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" 1031.72119140625;
	setAttr ".tgi[0].ni[5].y" -189.94174194335938;
	setAttr ".tgi[0].ni[5].nvs" 18305;
	setAttr ".tgi[0].ni[6].x" 1031.72119140625;
	setAttr ".tgi[0].ni[6].y" -612.79888916015625;
	setAttr ".tgi[0].ni[6].nvs" 18305;
	setAttr ".tgi[0].ni[7].x" 571.47552490234375;
	setAttr ".tgi[0].ni[7].y" -278.65008544921875;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" 1031.72119140625;
	setAttr ".tgi[0].ni[8].y" -295.65603637695312;
	setAttr ".tgi[0].ni[8].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -157.48874257512063 -373.2616353333849 ;
	setAttr ".tgi[1].vh" -type "double2" 538.30955723599379 47.03271339645012 ;
	setAttr -s 3 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -82.802253723144531;
	setAttr ".tgi[1].ni[0].y" -7.2968382835388184;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" 184.44503784179688;
	setAttr ".tgi[1].ni[1].y" -1.8958579301834106;
...
connectAttr "multDoubleLinear1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "line_grp3.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "master_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn";
connectAttr "radius_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "foot_guideShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "ulnaEnd_guide_ZRO.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
...
connectAttr "foot_guideShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn"
		;
