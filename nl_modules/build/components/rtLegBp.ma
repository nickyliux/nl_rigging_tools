...
//Name: rtLegBp.ma
//Last modified: Thu, Apr 09, 2026 01:20:36 AM
//Codeset: 1252
requires maya "2027";
...
fileInfo "UUID" "9C7EBA3C-48E9-1867-577A-47B19E048F80";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 112.46160923700127 118.06370380260333 102.61210603270057 ;
	setAttr ".r" -type "double3" -23.138352729045017 51.000000000012591 -2.5269757080003034e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 189.64355317736914;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "73F1B025-4490-6584-E0C5-DAA8DC17E264";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6F509E50-48A8-10C9-D688-719D19524ACC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E67E706F-4B19-8528-617C-98A0241BC8A3";
createNode displayLayerManager -n "layerManager";
	rename -uid "1975D6C9-4C43-2DC7-5105-2E8131994ABA";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0E6C5146-4029-2190-ED9F-578B479AF814";
