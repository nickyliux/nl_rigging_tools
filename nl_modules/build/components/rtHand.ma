...
//Name: rtHand.ma
//Last modified: Mon, Apr 14, 2025 04:03:43 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "4B9BE344-43A6-B3AE-AC03-399791C6B8CF";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -107.89996031824917 179.54818914108768 41.882411176106856 ;
	setAttr ".r" -type "double3" -34.538352729790631 -34.600000000031173 1.9319731231943675e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 60.229691795377249;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1F22E6FA-4E5E-B7BF-2CF5-F693D49C2EB7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DCAFB10A-46E8-AAA6-E094-E5971C86FECF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "40B158BC-4E53-65CE-52FC-D6843160144B";
createNode displayLayerManager -n "layerManager";
	rename -uid "FE558DA2-4FDE-80EE-7346-DFA0856DD1B8";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CF4D2EF6-4230-CEE1-5318-E3941B411C91";
