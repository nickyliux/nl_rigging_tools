...
//Name: rtHand.ma
//Last modified: Sat, Apr 12, 2025 11:27:58 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "887F06F4-4138-358E-7263-68812FCFF133";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -104.18086193901514 170.7959182631935 49.876641750021811 ;
	setAttr ".r" -type "double3" -24.938352729790569 -26.600000000031098 8.8926343756612898e-16 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E7A3B09B-49E0-F688-A1A1-0CA52348CE83";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4CCDE41A-4947-DF10-0375-79942012256D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FC0BCE7B-4C48-B44F-F76D-E882CE67D4CB";
createNode displayLayerManager -n "layerManager";
	rename -uid "69602A1C-48C9-1A59-5F2C-6ABD4E9F2927";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A6F8E456-459E-F1BC-B766-12A693DAF2C8";
