...
//Name: rtHand.ma
//Last modified: Mon, Jan 06, 2025 12:27:30 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "91177CD4-46F3-82E9-5B41-80BCE3C86673";
...
createNode transform -n "fgr00_1_guide" -p "fgr00_2_guide";
	...
	setAttr ".s" -type "double3" 1 1.0000000000000004 1 ;
createNode transform -n "ball_guide" -p "handJ_guide";
	rename -uid "C96B014B-4033-8B2A-FC5B-2698652D7761";
	setAttr ".t" -type "double3" -12.5 1.5777218104420236e-30 -3.5032461608120419e-46 ;
createNode nurbsCurve -n "ball_guideShape" -p "ball_guide";
	rename -uid "8ADC5991-4790-5A11-70A0-6B9DC40AD7E5";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 22;
	setAttr ".cc" -type "nurbsCurve" 
		...
		27
		3.0616171314629196e-17 0.5 3.0616171314629196e-17
		2.1648901508566386e-17 0.35355338454246521 0.35355338454246521
		1.8746996965264928e-33 3.0616171314629196e-17 0.5
		-2.1648901508566386e-17 -0.35355338454246521 0.35355338454246521
		-3.0616171314629196e-17 -0.5 3.0616171314629196e-17
		-2.1648901508566386e-17 -0.35355338454246521 -0.35355338454246521
		-1.8746996965264928e-33 -3.0616171314629196e-17 -0.5
		2.1648901508566386e-17 0.35355338454246521 -0.35355338454246521
		3.0616171314629196e-17 0.5 -3.0616171314629196e-17
		-0.35355338454246521 0.35355338454246521 2.1648901508566386e-17
		-0.5 1.8746996965264928e-33 3.0616171314629196e-17
		-0.35355338454246521 -0.35355338454246521 -2.1648901508566386e-17
		-3.0616171314629196e-17 -0.5 3.0616171314629196e-17
		0.35355338454246521 -0.35355338454246521 -2.1648901508566386e-17
		0.5 -1.8746996965264928e-33 -3.0616171314629196e-17
		...
		2.1648901508566386e-17 0.35355338454246521 0.35355338454246521
		1.8746996965264928e-33 3.0616171314629196e-17 0.5
		-0.35355338454246521 2.1648901508566386e-17 0.35355338454246521
		-0.5 3.0616171314629196e-17 1.8746996965264928e-33
		-0.35355338454246521 -2.1648901508566386e-17 -0.35355338454246521
		-1.8746996965264928e-33 -3.0616171314629196e-17 -0.5
		0.35355338454246521 -2.1648901508566386e-17 -0.35355338454246521
		0.5 -3.0616171314629196e-17 -1.8746996965264928e-33
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -99.307702090336619 167.04807491775162 15.255860397293969 ;
	setAttr ".r" -type "double3" -43.538352729790411 -53.000000000031022 -5.2849373297586077e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.812040297142886;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -78.882166401642294 145 2.0933301917225116 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C8794929-454C-EAA2-715E-35BE52481EF0";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "07DDDC75-44C1-6262-1B7A-EEB3C10C03B7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B4CCD465-4B7F-5D0C-09DF-BCBA423431E3";
createNode displayLayerManager -n "layerManager";
	rename -uid "1ADF12C2-4418-C07F-F160-5092D03A345B";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F168A72C-4BCB-AE3F-DBD6-F8944FC96AA0";
