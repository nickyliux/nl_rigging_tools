...
//Name: rtHand.ma
//Last modified: Thu, Dec 05, 2024 06:20:11 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "41F78F04-4DF0-FCB7-D3CF-2CA3036E7994";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -103.03101340221409 168.54804963699311 20.000994043908857 ;
	setAttr ".r" -type "double3" -38.138352729789517 -47.800000000029996 -4.7349370140208904e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 38.167204755515648;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FC13E1EE-40AF-E865-4C09-4AA15218AB7F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "47D63B07-4436-43BC-DF2D-2AA193522836";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DCE86A04-48DC-5BAB-056A-82A808440EA7";
createNode displayLayerManager -n "layerManager";
	rename -uid "6A4CC5BE-4D49-703A-7B2B-718C43C72522";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8A6CBB22-43BE-66EC-F8EA-B5BF7FE4CC52";
