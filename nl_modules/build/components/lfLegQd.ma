...
//Name: lfLegQd.ma
//Last modified: Sat, Apr 12, 2025 11:30:37 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "5A71C797-4587-7C55-51CE-CF86B28C96C1";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 127.93916175948431 83.029955106069082 51.6873376490515 ;
	setAttr ".r" -type "double3" -12.938352728548931 -300.99999999945572 1.5438444439613767e-15 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 178.09103854898947;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5FF02B38-459B-A4E9-8719-33B197567C2F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1AE600A4-408F-7BD8-DD68-61A2325E2F1F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ECF61AE4-460A-A964-79C2-07A1F6D4A22D";
createNode displayLayerManager -n "layerManager";
	rename -uid "319BD027-4BC9-3EB1-585B-CD9AD8C869E9";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0AA886B7-47B7-DE01-A9A4-22B7CDCAF263";
