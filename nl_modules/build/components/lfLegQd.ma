...
//Name: lfLegQd.ma
//Last modified: Fri, Dec 27, 2024 08:32:31 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "914BE21C-44A8-B75A-9506-1686A8BE96EE";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 99.64173879841222 94.649169384223867 38.091880062716065 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DF3ACB15-4F9F-EF73-0602-5BB5734FE379";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D3A2B3DE-4268-D9B7-FC78-78AF6170D2BF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "37497E58-46E2-2D88-AC02-448040C08FA7";
createNode displayLayerManager -n "layerManager";
	rename -uid "2DB34FCF-450F-E71A-6BA6-7689AABF4224";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F8BD7180-4865-62E0-C36A-2B84DAF2C652";
