...
//Name: lfLegQd.ma
//Last modified: Mon, Jun 02, 2025 12:06:06 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "AEE9EC80-47DE-A79B-3102-C39D140208AB";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 290.53883996270554 259.0716703013228 122.03230805767599 ;
	setAttr ".r" -type "double3" -33.938352729536874 -298.99999999910631 6.5604199024287965e-15 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 382.92751547431772;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F8FCEC97-4AD2-055E-3B9F-BAA3B72CDD93";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BC0CC96C-4750-EA92-3B8A-318AAEA29F89";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BFE1C3B5-4D4D-03F3-E655-94B189B0C831";
createNode displayLayerManager -n "layerManager";
	rename -uid "13900A42-49E2-4F90-DECE-D9B4BE143053";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DE3D452E-4348-8E91-653B-49BBA3A02E58";
