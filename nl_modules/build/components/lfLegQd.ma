...
//Name: lfLegQd.ma
//Last modified: Sat, May 31, 2025 05:18:24 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "9620310E-4BBE-F569-4C80-C1AEBD99D79D";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 223.32510043642804 177.37792825932158 195.97714870178612 ;
	setAttr ".r" -type "double3" -22.538352729536665 -324.19999999910777 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 376.52410749902248;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BAA06B2A-46F0-1E38-58E9-3B827FA7B147";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D5CB2C00-4EB8-9ADC-8C51-BFB0C0E5462F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2EB99675-40B7-5324-036C-E0B13673021F";
createNode displayLayerManager -n "layerManager";
	rename -uid "257EE027-4F5F-0A1A-0A6F-249B48D72890";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E9911351-4BFB-EE96-5EC4-309A5036D05D";
