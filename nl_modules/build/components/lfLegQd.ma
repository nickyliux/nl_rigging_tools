...
//Name: lfLegQd.ma
//Last modified: Tue, Jun 30, 2026 12:08:14 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "BB66EEDF-4002-337F-B995-09940250CB0A";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 125.43341575397827 79.441233540223294 110.8833971985826 ;
	setAttr ".r" -type "double3" -12.938352765757561 -312.20000000038272 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 173.35561164087636;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2A8E6F62-48CB-0B41-62D6-0E82CBD3162B";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5C6A9224-44BF-9045-08A2-FFA34F75C95E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "03018F71-455E-30F6-DE34-FC83124245C2";
createNode displayLayerManager -n "layerManager";
	rename -uid "62268130-4BA0-F7A7-6BCD-E68F7B2EDA9C";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CD7A0421-4B09-D420-83B4-F19906E2D09A";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "32B6331D-49FB-74C8-0A66-B48C9B326431";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
