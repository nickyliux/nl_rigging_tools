...
//Name: lfLegQd.ma
//Last modified: Fri, Jun 06, 2025 02:58:14 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "B1236E0D-4F2F-BEAE-ED76-C0BDEB0B6A4B";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 240.96849116644685 113.75939629941028 67.689882464955005 ;
	setAttr ".r" -type "double3" -14.73835272954612 -292.5999999991019 -2.0690823528438203e-15 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6F5B107C-45FE-7B16-C740-1E9E69A1615D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "10E142C2-443A-F760-5BF2-DAAEC0B082B8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0345D1F6-4D22-EDCA-81D4-97AC056AFC42";
createNode displayLayerManager -n "layerManager";
	rename -uid "6DB341E0-47DE-DDE7-8148-7EA81F2E64B2";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F5E108D0-44FB-2F06-DF4F-6EB08FDBA630";
