...
//Name: lfLegQd.ma
//Last modified: Fri, Jun 27, 2025 08:38:03 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "AAC2EE57-43BE-030A-8E1C-CABEC36AE9ED";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 81.983199627936685 60.05270596078033 42.541664615249559 ;
	setAttr ".r" -type "double3" -6.3383527295652353 -314.59999999889084 5.6621463581884219e-16 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 119.1195487675387;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 9.9999998947873721 -5.5511151231257827e-16 -50.000000359937928 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "92D532F2-4FAE-675B-7C74-C0B15A2F7BA7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1E9EA33B-4F45-DAD0-EE7B-08820DAEFE20";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DADBD3FD-4797-5BA6-B2CF-2597AD76855A";
createNode displayLayerManager -n "layerManager";
	rename -uid "02E4F336-494A-4BAD-5537-249D87E595C7";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C33AB2BC-48DE-D459-FE90-BCA561DC6FF9";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "E33DEC49-4843-0AC4-0B5E-AFBEA72071D8";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -108.33332902855359 1140.3454831420261 ;
	setAttr ".tgi[0].vh" -type "double2" 753.57139862719157 1463.3208688932923 ;
	setAttr -s 4 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 329.07122802734375;
	setAttr ".tgi[0].ni[0].y" 1409.5234375;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" -95.484687805175781;
	setAttr ".tgi[0].ni[1].y" 1393.9571533203125;
	setAttr ".tgi[0].ni[1].nvs" 18305;
	setAttr ".tgi[0].ni[2].x" 321.42855834960938;
	setAttr ".tgi[0].ni[2].y" 1274.2857666015625;
