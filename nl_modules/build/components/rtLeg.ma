...
//Name: rtLeg.ma
//Last modified: Thu, Feb 13, 2025 04:40:09 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "2F8D5954-4D33-481C-BBDF-808590C99454";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 77.028941764297215 96.236151212343174 117.56609876965989 ;
	setAttr ".r" -type "double3" -18.338352728930733 47.800000000003784 -3.5512027605138779e-15 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "24E990A8-4323-08E4-81AC-0FA3F4FA0E32";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C5D257B7-44D0-7F80-A43E-5387274BCD97";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A276D721-434E-ADB7-52B6-38BCE4F633F8";
createNode displayLayerManager -n "layerManager";
	rename -uid "2AC764F3-4F20-7C80-ADC0-C3ABB9C781F5";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DE5683F0-4D84-A050-F431-38A12660AB13";
