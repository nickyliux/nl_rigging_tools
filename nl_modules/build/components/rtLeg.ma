...
//Name: rtLeg.ma
//Last modified: Mon, Dec 09, 2024 10:47:30 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "8684152F-4B1D-D6D4-96EB-54A7D2DE8300";
...
createNode pointConstraint -n "ball_guide_ofs_pointConstraint1" -p "ball_guide_ofs";
	...
	setAttr -k on ".w0";
	setAttr -k on ".w1" 2;
createNode transform -n "toe_guide_ofs" -p "master_guide";
...
createNode transform -n "toe_guide" -p "toe_guide_ofs";
...
createNode transform -n "toe00_2_guide" -p "toe00_2_guide_ZRO";
	...
	setAttr ".t" -type "double3" 0.33300000000000018 0 3.9000000000000004 ;
...
createNode transform -n "toe00_1_guide" -p "toe00_2_guide";
	...
	setAttr ".t" -type "double3" 8 3.5527136788005009e-15 0 ;
...
createNode transform -n "toe01_3_guide" -p "toe01_2_guide";
	...
	setAttr ".t" -type "double3" -2.6000000000000014 -1.0658141036401503e-14 -8.8817841970012523e-16 ;
createNode transform -n "toe01_4_guide" -p "toe01_3_guide";
	rename -uid "ABB2C348-4D83-A481-5D90-0F8B9EEC6B5F";
	setAttr ".t" -type "double3" -1.0000000000000018 -3.5527136788005009e-15 8.8817841970012523e-16 ;
createNode transform -n "toe01_5_guide" -p "toe01_4_guide";
	rename -uid "5EBFDF14-4B8D-81B3-886A-C7A21D91B5BD";
	setAttr ".t" -type "double3" -0.99999999999999467 -8.8817841970012523e-15 -1.7763568394002505e-15 ;
...
createNode transform -n "toe03_1_guide" -p "toe03_2_guide";
	...
	setAttr ".t" -type "double3" 7.9999999999999991 -3.5527136788005009e-15 8.8817841970012523e-16 ;
...
createNode transform -n "toe04_4_guide" -p "toe04_3_guide";
	...
	setAttr ".t" -type "double3" -1.0000000000000018 -7.1054273576010019e-15 8.8817841970012523e-16 ;
createNode transform -n "toe04_5_guide" -p "toe04_4_guide";
	rename -uid "97F7C493-4F7F-13B4-1C0A-909CC6E35C3D";
	setAttr ".t" -type "double3" -0.99999999999999467 -1.4210854715202004e-14 -1.7763568394002505e-15 ;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "E233CEE3-40F6-1AF5-8968-F8A26654947E";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		11.26773676203117 8.2535382583711187e-16 -15.350801384937162
		-8.1660387114908776e-15 8.0595107077863571e-16 -16.20131601418241
		-11.267736762031188 8.2535382583711157e-16 -15.350801384937162
		-11.689010839838973 1.2470934284616338e-31 10.135420529018585
		-11.267736762031188 -8.2535382583711157e-16 37.470468453307603
		-1.0052680407308491e-14 -8.059510707786362e-16 38.320983082552885
		11.26773676203117 -8.2535382583711157e-16 37.470468453307603
		11.689010839838955 -2.6978565941924595e-32 10.135420529018592
		11.26773676203117 8.2535382583711187e-16 -15.350801384937162
		-8.1660387114908776e-15 8.0595107077863571e-16 -16.20131601418241
		-11.267736762031188 8.2535382583711157e-16 -15.350801384937162
		;
...
createNode nurbsCurve -n "line_09Shape" -p "line_09";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-11.000000000000004 6.2389736377818963 5.0165619522957163
		-11 3.9000000000000017 12.667
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_10Shape" -p "line_10";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-11 3.9000000000000017 12.667
		-10.999999999999996 2.8474618629981485 16.10969712146693
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_11Shape" -p "line_11";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-10.999999999999996 2.8474618629981485 16.10969712146693
		-10.999999999999996 2.5550901582754113 17.066001877429962
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_12Shape" -p "line_12";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-13 6.2389736377818963 5.0165619522957163
		-13 3.9000000000000017 12.667
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_13Shape" -p "line_13";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-13 3.9000000000000017 12.667
		-12.999999999999989 3.1398335677208848 15.153392365503892
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_14Shape" -p "line_14";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12.999999999999989 3.1398335677208848 15.153392365503892
		-12.999999999999986 2.8474618629981485 16.10969712146693
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_15Shape" -p "line_15";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-12.999999999999986 2.8474618629981485 16.10969712146693
		-12.999999999999977 2.5550901582754117 17.066001877429958
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_16Shape" -p "line_16";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-15 6.2389735742036105 5.0162290957995372
		-15 3.8999999364217164 12.666667143503823
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_17Shape" -p "line_17";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-15 3.8999999364217164 12.666667143503823
		-14.999999999999995 3.1398335041425982 15.153059509007718
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_18Shape" -p "line_18";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14.999999999999995 3.1398335041425982 15.153059509007718
		-14.999999999999993 2.8474617994198614 16.109364264970754
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_19Shape" -p "line_19";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-14.999999999999993 2.8474617994198614 16.109364264970754
		-14.999999999999991 2.555090094697126 17.06566902093379
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_20Shape" -p "line_20";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-16.999999999999996 6.2389736377818963 5.0165619522957172
		-17 3.9000000000000012 12.667
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_21Shape" -p "line_21";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-17 3.9000000000000012 12.667
		-16.999999999999996 3.1398335677208848 15.153392365503894
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_22Shape" -p "line_22";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-16.999999999999996 3.1398335677208848 15.153392365503894
		-16.999999999999996 2.8474618629981467 16.10969712146693
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_23Shape" -p "line_23";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-16.999999999999996 2.8474618629981467 16.10969712146693
		-16.999999999999989 2.55509015827541 17.066001877429965
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_24Shape" -p "line_24";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		-19.000000000000004 6.2389736377818963 5.0165619522957163
		-19 3.9000000000000017 12.667
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_25Shape" -p "line_25";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-19 3.9000000000000017 12.667
		-18.999999999999989 3.1398335677208848 15.153392365503892
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_26Shape" -p "line_26";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-18.999999999999989 3.1398335677208848 15.153392365503892
		-18.999999999999982 2.8474618629981485 16.10969712146693
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_27Shape" -p "line_27";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		-18.999999999999982 2.8474618629981485 16.10969712146693
		-18.999999999999968 2.5550901582754117 17.066001877429958
		;
	setAttr ".adot" yes;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 65.753163824035155 102.45822508459018 125.97430602120883 ;
	setAttr ".r" -type "double3" -20.138352728930659 44.600000000003654 1.1167269439691022e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 175.11792888159391;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -10.000000000000002 7.6999998250826103 -3.3295782986275668e-07 ;
...
parent -s -nc -r -add "|module_grp|master_guide|hip_guide_ofs|hip_guide|hip_guideShape" "toe_guide" ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A433F26C-4D6F-74C4-85EB-8184D2446892";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CE934FBF-4751-77AF-9027-0CA51F3B6D28";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9A4035E4-4B87-C1AF-D44E-C4B54E78EEF6";
createNode displayLayerManager -n "layerManager";
	rename -uid "2E49F44B-4D65-2A80-8CDF-E2A08D9D882B";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F0412BB9-447C-052B-DF1D-D5A04FA68E75";
...
connectAttr "toe_guide.t" "ball_guide_aimConstraint1.tg[0].tt";
connectAttr "toe_guide.rp" "ball_guide_aimConstraint1.tg[0].trp";
connectAttr "toe_guide.rpt" "ball_guide_aimConstraint1.tg[0].trt";
connectAttr "toe_guide.pm" "ball_guide_aimConstraint1.tg[0].tpm";
connectAttr "ball_guide_aimConstraint1.w0" "ball_guide_aimConstraint1.tg[0].tw";
connectAttr "toe_guide.wm" "ball_guide_aimConstraint1.wum";
...
connectAttr "toe_guide.t" "ball_guide_ofs_aimConstraint1.tg[0].tt";
connectAttr "toe_guide.rp" "ball_guide_ofs_aimConstraint1.tg[0].trp";
connectAttr "toe_guide.rpt" "ball_guide_ofs_aimConstraint1.tg[0].trt";
connectAttr "toe_guide.pm" "ball_guide_ofs_aimConstraint1.tg[0].tpm";
...
connectAttr "ball_guide_ofs_pointConstraint1.w0" "ball_guide_ofs_pointConstraint1.tg[0].tw"
		;
connectAttr "toe_guide.t" "ball_guide_ofs_pointConstraint1.tg[1].tt";
connectAttr "toe_guide.rp" "ball_guide_ofs_pointConstraint1.tg[1].trp";
connectAttr "toe_guide.rpt" "ball_guide_ofs_pointConstraint1.tg[1].trt";
connectAttr "toe_guide.pm" "ball_guide_ofs_pointConstraint1.tg[1].tpm";
...
connectAttr "toe_guide.wm" "DCM_6.imat";
...
connectAttr "toe_guide.msg" ":hyperGraphLayout.hyp[83153].dn";
connectAttr "palm_guide_ofs.msg" ":hyperGraphLayout.hyp[83158].dn";
connectAttr "toe_guide_ofs.msg" ":hyperGraphLayout.hyp[83161].dn";
