...
//Name: rtLeg.ma
//Last modified: Wed, Mar 12, 2025 04:13:55 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "5699366E-4482-C4CA-4C2E-33ABD174FFD4";
...
createNode transform -n "master_guide" -p "module_grp";
	...
	addAttr -ci true -sn "autoAimIwd" -ln "autoAimIwd" -dv 1 -min 0 -max 1 -at "float";
	addAttr -ci true -sn "autoAimOwd" -ln "autoAimOwd" -dv 1 -min 0 -max 1 -at "float";
	setAttr ".ovc" 13;
	...
	setAttr -cb on ".autoAimBwd" 0.5;
	setAttr -cb on ".autoAimIwd" 0.20000000298023224;
	setAttr -cb on ".autoAimOwd" 0.5;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 75.792595459419715 76.873660215707005 158.46657308812954 ;
	setAttr ".r" -type "double3" -10.538352728930818 25.000000000003979 4.3866922569746755e-16 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "03316A68-4C80-AA0B-0912-2C97497352A6";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "542326BE-43C1-35AD-7710-B092435E3052";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4366FC5A-4412-C818-30F9-BC8131AEE4C3";
createNode displayLayerManager -n "layerManager";
	rename -uid "2209AB0C-4FB7-288B-46D2-44A667589106";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "ACB95B3D-4FD3-E536-5A43-C38BD7C8947F";
