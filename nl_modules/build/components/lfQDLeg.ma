...
//Name: lfQDLeg.ma
//Last modified: Mon, Dec 23, 2024 10:37:28 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "92AE10DB-40FF-681B-7EB0-AC889A09CFE9";
...
createNode transform -n "digit_guide_ofs" -p "master_guide";
	...
	setAttr ".r" -type "double3" 4.2092705161243562e-11 -80.931241431649624 89.999999999958362 ;
	setAttr -cb on ".ro";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 88.255839022944031 63.031711360747124 33.242616794667711 ;
	setAttr ".r" -type "double3" -10.53835272843644 -311.39999999978494 -1.2023656493447568e-15 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 104.18252835491032;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A9434FCF-44D2-95FB-80F1-10A9A970B1E9";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FD9E0AB8-4289-3727-9E29-1DB3725435D6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "23B2719F-4C2C-C3F8-B3CC-0B9CABE04EB6";
createNode displayLayerManager -n "layerManager";
	rename -uid "33A7EF51-434E-90E9-F6C3-AC93ED4C8AEF";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "AAEAC471-4FE7-17D9-F4CC-4DACE80D709D";
