...
//Name: lfQDLeg.ma
//Last modified: Mon, Dec 23, 2024 04:13:35 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "E2BA2FD0-457C-0EE3-535E-F9A588FF2FB2";
...
createNode transform -n "digit_guide_ofs" -p "master_guide";
	...
	setAttr ".r" -type "double3" 0 -80 89.999999999958362 ;
	setAttr -cb on ".ro";
...
createNode transform -n "ball_guide_ofs1" -p "master_guide";
	...
	setAttr ".r" -type "double3" 90 -45 -90.000000000000909 ;
	setAttr -cb on ".ro";
	setAttr ".s" -type "double3" 0.99999999999999967 1.0000000000000004 0.99999999999999944 ;
...
createNode nurbsCurve -n "line_04Shape" -p "line_04";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		10 20 -51
		9.9999999906678276 5.0000000471427581 -44.999999732640163
		;
	setAttr ".adot" yes;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 85.775029106033557 80.346578871649342 23.350620293737318 ;
	setAttr ".r" -type "double3" -20.138352728508998 -306.59999999959825 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 100.37728847609699;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5B43CE74-4534-600C-35C7-9393FEE1EA46";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A193D0F6-47E6-493A-23EF-F2B8380C6036";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "173988B7-4F2F-0EE2-973C-5088A0703D3C";
createNode displayLayerManager -n "layerManager";
	rename -uid "9D5510A5-4E76-8722-0176-2AAFF03270D7";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2BBF4A6E-40E0-3F77-3F70-0DADC7D90DD7";
