...
//Name: lfLeg.ma
//Last modified: Wed, May 07, 2025 08:28:20 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "CCE4AE1E-41EB-C3B0-EFC4-C289907265C3";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 130.87801958710338 90.036713437748261 100.00439150427742 ;
	setAttr ".r" -type "double3" -14.738352729768573 55.40000000001249 0 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A08229A5-4641-1572-72B1-A5B525D27A3F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9A67329C-415C-4851-9BB8-D89855B9E7E2";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "862EB957-414D-E437-FE67-9593B2AF19ED";
createNode displayLayerManager -n "layerManager";
	rename -uid "63CC35D8-426C-4EA0-D6A5-2F936A6C941F";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "131C2F8A-4D26-D12D-F4CB-8CB3736813C9";
