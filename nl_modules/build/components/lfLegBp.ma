...
//Name: lfLegBp.ma
//Last modified: Tue, Jun 30, 2026 12:12:18 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "74E44117-47B1-F2CC-6A6C-B1AC35050E53";
createNode transform -s -n "persp";
	rename -uid "2CFF45DD-487A-9CD1-767B-A089B899D93C";
	setAttr ".t" -type "double3" 113.15336071455643 97.442144434680841 136.41144170620612 ;
	setAttr ".r" -type "double3" -16.538352733077161 404.19999999845811 1.1091182943309533e-15 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AC64C011-4417-B057-C702-0E8720F6DE59";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F63DA2D7-4073-BFD5-608E-51A61A7545C9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "06CF76C0-4D32-0B19-B13E-278DAB755426";
createNode displayLayerManager -n "layerManager";
	rename -uid "7C760087-4CBA-63B1-A715-90ABE8BEA556";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DFF6FEC0-4EBF-082E-9A43-A0A98A0BFDAD";
