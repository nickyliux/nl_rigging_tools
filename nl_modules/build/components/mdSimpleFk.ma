...
//Name: mdSimpleFk.ma
//Last modified: Wed, Mar 11, 2026 12:39:24 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "47B0ECE5-4906-5743-256C-3DA7C619C46C";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.68380001500941 31.482686049507155 30.671617519712584 ;
	setAttr ".r" -type "double3" -30.338352729831648 31.399999999999274 1.863131457211649e-15 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3686A50B-49FE-3077-4159-8999961AFA0D";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "72275FBF-4B68-1B15-6DE3-EBBAF3EFFC33";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "01D8D7DF-4231-1E91-E210-7DB9CCFB4BAE";
createNode displayLayerManager -n "layerManager";
	rename -uid "06B1BC18-4085-56ED-7589-B4B0C2F84DE6";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "32142832-4F5C-E1A9-7CBD-11B935669C1F";
