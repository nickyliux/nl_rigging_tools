...
//Name: mdSimpleFk.ma
//Last modified: Thu, Apr 09, 2026 01:11:48 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "9865F03F-4778-FBB8-F543-0EA18DCBB817";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.754883166995818 25.023078441366518 25.166579862658594 ;
	setAttr ".r" -type "double3" -23.138352729831738 45.799999999999308 0 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EB04416C-42F4-6EC1-52E3-0CA30EEB7462";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "51344707-4B36-7F61-DE06-BFB5F6B7F489";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4F7BD8AB-4B7A-0C0A-3962-29AC3F1E2B6C";
createNode displayLayerManager -n "layerManager";
	rename -uid "5932407B-49D0-47D9-2892-67A5454B1E9F";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1B6EA790-484F-D80F-9C4D-E396D53C1CB6";
