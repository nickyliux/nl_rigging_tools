...
//Name: mdSimpleFk.ma
//Last modified: Wed, Apr 08, 2026 01:30:53 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "15A08D80-4FA4-F995-F427-1B8C9E3F1933";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 29.837342545208458 32.001634172189462 28.906731925092636 ;
	setAttr ".r" -type "double3" -30.938352729831692 34.599999999999312 -1.931973123193626e-15 ;
	setAttr -cb on ".ro";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1AF8B624-43B5-4A65-587C-B19DF8092F66";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F55A0E2A-4916-B03D-2758-3DB15C288DBA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9F0476DC-4CDC-24E9-293E-40A53C89C34F";
createNode displayLayerManager -n "layerManager";
	rename -uid "9D84E7BD-413F-EFDD-5BA1-B2A7F1AC6DA6";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "09F20CF2-4601-5F59-01A9-D48B5F2D10EA";
