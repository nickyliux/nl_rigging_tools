...
//Name: mdSimpleFk.ma
//Last modified: Tue, Oct 07, 2025 04:15:50 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "15E6F707-47CD-9193-A4E9-B596703FE425";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 54.910388049806173 34.88715590075109 37.408058389298112 ;
	setAttr ".r" -type "double3" -27.338352729831534 47.800000000000303 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 80.495183114188407;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0662DDBE-41A1-4655-1579-CEB3D3B0470C";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D0D1B045-46C2-DEF4-BDFE-3F9F662D47E9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "209B5793-4C12-C07A-E012-0DBC525ECC27";
createNode displayLayerManager -n "layerManager";
	rename -uid "DE865110-4ED4-F4B7-49F9-6E80E6EEB49D";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FB58C396-462F-F800-B0CE-FB82B6928F4E";
