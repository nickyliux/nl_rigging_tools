...
//Name: mdSimpleFk.ma
//Last modified: Sun, May 03, 2026 04:51:49 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "948EA31C-4442-B470-E61D-EAA0FFAB4E83";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 145.84143388879744 108.85640710812959 110.18446407820812 ;
	setAttr ".r" -type "double3" -27.338352729831971 39.79999999999967 -2.0699094694800727e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 223.58617612820979;
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "2E0A8EDE-4AE0-ABF9-E742-0FA48C14582F";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 1;
	setAttr ".ls" 2;
	setAttr ".cc" -type "nurbsCurve" 
		...
		6 0 1 3 4 6 7
		6
		1.0269602286740684e-15 8.3857666503442303 0
		-5.6249999999999982 5.6250000000000027 0
		-5.6250000000000018 -5.6249999999999982 0
		5.6249999999999982 -5.625 0
		5.6250000000000018 5.6250000000000018 0
		1.0269602286740684e-15 8.3857666503442303 0
		;
	setAttr ".adot" yes;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D1FA2079-4C5A-F84B-B5AF-BCB7E2821557";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "859B485C-42A0-4E99-08BE-DAB2AF6A8EA7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2287828C-4B19-9D11-399C-3AB9D35B9665";
createNode displayLayerManager -n "layerManager";
	rename -uid "380E253E-4B94-BCC7-7537-8EA358E73F9F";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C1C10E73-42CC-B465-8896-37BEC5074A47";
