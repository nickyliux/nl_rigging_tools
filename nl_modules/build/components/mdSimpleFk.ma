...
//Name: mdSimpleFk.ma
//Last modified: Sat, Dec 13, 2025 01:11:12 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "E0F548FC-4B06-04FC-822A-E1A7BB70B280";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 33.357503382157233 25.813245985561458 53.380644936871526 ;
	setAttr ".r" -type "double3" -18.938352729831582 30.999999999999218 1.8552706565324374e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 76.186379033612184;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 7.3955709864469857e-32 0 1.1102230246251565e-15 ;
...
createNode transform -n "master_guide" -p "module_grp";
	...
	setAttr -k on ".segNum";
	setAttr -k on ".parentNameMatch" -type "string" "NONE";
...
createNode nurbsCurve -n "squareRShape1" -p "master_guide";
	rename -uid "2997D8C6-493D-E63C-CBA5-1581CF958F48";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 16;
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		2.9115597151535262 5.8231194303070604 1.1951965646133099e-16
		1.6120302010017852e-16 8.2652902114279545 1.6902631913778761e-16
		-2.9115597151535262 5.8231194303070559 1.1951965646133091e-16
		-2.6326451057139852 2.044497909740548e-15 -6.8985157699450679e-32
		-2.9115597151535262 -5.8231194303070524 -1.1951965646133099e-16
		-2.6371386078780171e-16 -5.2652902114279598 -1.6902631913778776e-16
		2.9115597151535262 -5.8231194303070559 -1.1951965646133091e-16
		2.6326451057139852 1.0535185683243364e-15 -1.0079757139273961e-31
		2.9115597151535262 5.8231194303070604 1.1951965646133099e-16
		1.6120302010017852e-16 8.2652902114279545 1.6902631913778761e-16
		-2.9115597151535262 5.8231194303070559 1.1951965646133091e-16
		;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5CB148D6-4C5A-15DB-5193-66BD97B76CC1";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C0E021D6-4F8A-48A6-CC3A-A2A14ECC2122";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0801A241-4651-98D9-3809-0BB25972F985";
createNode displayLayerManager -n "layerManager";
	rename -uid "701F6C8E-4762-7588-9DAF-1BBDC8A7D1A9";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "17169E1E-4D7A-EAF5-F054-A0A8FFB612FD";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "BFE75C72-4A53-EBD1-C24C-AA88286851E0";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 69677.972876233383 -31501.19117135333 ;
	setAttr ".tgi[0].vh" -type "double2" 87249.401840413993 31498.81023680645 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -av -k on ".fzn";
