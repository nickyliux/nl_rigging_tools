...
//Name: mdSimpleFk.ma
//Last modified: Thu, Apr 16, 2026 09:50:07 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "490551AD-445E-E5E8-CABE-15A373A24EC9";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 47.760893384850583 29.408852458673493 3.6999038321692677 ;
	setAttr ".r" -type "double3" -31.53835272983186 59.399999999999601 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 55.824476164551356;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C91E35D9-4B1E-9C67-AAED-3282DA7B5343";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "46DBA19A-487B-537E-1730-549F5F3D8360";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CF016BF5-4219-4A8F-082D-2793ACE37F28";
createNode displayLayerManager -n "layerManager";
	rename -uid "6ACE00F6-4C91-D8E9-85C0-EFA77B867330";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "043E2DBC-4D7B-4E56-AD73-3FAD22238150";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "593140AC-420A-53CC-3967-7BB3C4708E60";
