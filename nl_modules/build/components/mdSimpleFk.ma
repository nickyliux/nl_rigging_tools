...
//Name: mdSimpleFk.ma
//Last modified: Sat, Apr 25, 2026 10:56:24 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "F0BE8D90-4831-B304-AAE8-DAB7689F6D31";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 124.91954216372162 82.151507519730217 37.629773676958948 ;
	setAttr ".r" -type "double3" -29.738352729831902 52.999999999999588 0 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 153.16460648838427;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "04BAD2DB-4DB8-3F27-E798-2D8533D03313";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "63E1C430-4870-E58F-A5B8-1DB8DCD27254";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "70455C3D-49CC-0B17-FA0F-04A0D109913A";
createNode displayLayerManager -n "layerManager";
	rename -uid "43D8A350-48A7-D99D-5BBA-5DA4117481F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0FE819D3-4ABC-CA7B-B7C5-CD8A23EEC35A";
