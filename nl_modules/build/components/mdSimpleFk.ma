...
//Name: mdSimpleFk.ma
//Last modified: Thu, Oct 09, 2025 01:39:06 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "6A16F736-40C1-1DD5-793C-ADB876523334";
createNode transform -s -n "persp";
	rename -uid "83BBC351-4169-8A57-6147-3688C3C5E65F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 53.458205199828015 33.101036237929094 36.568724606635449 ;
	setAttr ".r" -type "double3" -27.338352729831531 46.600000000000293 2.314519352665739e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E4BD1A20-4E99-1123-5E44-089307917010";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 78.259351593274005;
...
createNode nurbsCurve -n "squareRShape1" -p "master_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		1.6120302010017852e-16 5.2652902114279545 1.6902631913778761e-16
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "65614F50-4933-5CA1-3B9F-D9B4A02F5368";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0BCD0371-492E-01C2-BD32-C1A2FC268641";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "81CE1518-4107-DF85-67E6-B1A192695710";
createNode displayLayerManager -n "layerManager";
	rename -uid "050CDCAD-41C9-DFF1-9289-9591BF73FA29";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDE7F8A1-4185-37A4-5FA7-49A7396409D6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1380EA01-40CE-6981-CB9A-7B854192C874";
