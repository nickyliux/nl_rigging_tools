...
//Name: lfQFLeg.ma
//Last modified: Wed, Aug 14, 2024 07:38:05 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "A210A121-4009-C46D-F9D4-6BBF1F1BDEF8";
...
createNode transform -n "palm_toePos_guide" -p "master_guide";
	rename -uid "5CCF3868-407B-AFCD-CBF3-C9A97FCE1E5F";
	addAttr -ci true -sn "wsMirrorAxis" -ln "wsMirrorAxis" -at "float";
	setAttr -l on -k off ".v";
	setAttr ".ovc" 13;
...
createNode locator -n "palm_toePos_guideShape" -p "palm_toePos_guide";
	rename -uid "9924EE35-4618-D7D1-CA7A-30A2BF1B7C25";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 25;
	setAttr ".los" -type "double3" 2 0 2 ;
...
createNode transform -n "line_10" -p "line_grp";
	rename -uid "605F4BEA-41D8-F0F1-2628-5C9D6D4D19C0";
	setAttr -cb on ".ro";
	setAttr ".it" no;
createNode nurbsCurve -n "curveShape1" -p "line_10";
	rename -uid "C0FDD48C-4D55-BF19-A3FD-01B88DF636A5";
	setAttr -k off ".v";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr -s 2 ".cp";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		20 74 70
		19.999999999999172 74 15
		;
createNode joint -n "hip_guide_line1" -p "master_guide";
	rename -uid "AC86AC94-444B-426F-9649-B683DB6C253E";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "hip_guide_line1_poiCst" -p "hip_guide_line1";
	rename -uid "1F2A48DE-492D-AFBB-89D9-0B87129156B0";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".rst" -type "double3" 20.000000000000004 145 60 ;
	setAttr -k on ".w0";
createNode joint -n "upr_guide_line1" -p "hip_guide_line1";
	rename -uid "FE4C43AD-4283-9A4C-4A26-DA862098DEFD";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "upr_guide_line1_poiCst" -p "upr_guide_line1";
	rename -uid "3301D68D-407D-C7D1-1320-4E9219B86A33";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "upr_guideW0" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
...
createNode joint -n "lwr_guide_line1" -p "upr_guide_line1";
	rename -uid "7C0842DD-4C28-130C-29AC-6A9500DE582D";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "lwr_guide_line1_poiCst" -p "lwr_guide_line1";
	rename -uid "EEE600EB-4A3E-DA98-AC18-C594BE0E8BD0";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".rst" -type "double3" 6.7501559897209518e-14 -44 -15 ;
	setAttr -k on ".w0";
createNode joint -n "palm_guide_line1" -p "lwr_guide_line1";
	rename -uid "A56A5FAA-46EF-C579-F7BC-50BA28414630";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "palm_guide_line1_poiCst" -p "palm_guide_line1";
	rename -uid "374709D5-4D0E-9444-0B07-A6A55F0592C2";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".rst" -type "double3" -1.8474111129762605e-13 -33 0 ;
	setAttr -k on ".w0";
createNode joint -n "fetlock_guide_line1" -p "palm_guide_line1";
	rename -uid "2EEDE481-42A2-A484-C402-1E804C7A9EA2";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "fetlock_guide_line1_poiCst" -p "fetlock_guide_line1";
	rename -uid "3A3B8E14-404D-2380-B907-6EBAE2E68173";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "fetlock_guideW0" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".rst" -type "double3" 1.1723955140041653e-13 -31 -5.0000000000000036 ;
	setAttr -k on ".w0";
createNode joint -n "pastern_guide_line1" -p "fetlock_guide_line1";
	rename -uid "05437331-4C8F-F7BE-F6FE-3A964D2D88D1";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "pastern_guide_line1_poiCst" -p "pastern_guide_line1";
	rename -uid "5D6EE79D-4BB0-0FE0-2465-EFAF5AD424E8";
...
createNode joint -n "pasternTip_guide_line1" -p "pastern_guide_line1";
	rename -uid "A880283E-4E3B-CEAF-3A40-F6A827D13281";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "pasternTip_guide_line1_poiCst" -p "pasternTip_guide_line1";
	rename -uid "435D3F5B-46BC-9320-C4F5-318CFFBF7C8C";
...
createNode joint -n "plane_guide_line1" -p "master_guide";
	rename -uid "D80FE2A5-4F6A-D589-376C-909A04351C4E";
	setAttr -l on -k off ".v";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
...
createNode pointConstraint -n "plane_guide_line1_poiCst" -p "plane_guide_line1";
	rename -uid "79937068-46F5-37D3-AF77-55A89F8C4D22";
...
createNode joint -n "pvc_guide_line1" -p "plane_guide_line1";
	rename -uid "63573F44-4326-C1DC-3363-E69D587038AA";
	setAttr -l on -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 18;
	setAttr -k off ".tx";
...
createNode pointConstraint -n "pvc_guide_line1_poiCst" -p "pvc_guide_line1";
	rename -uid "41004A72-4CA7-373A-02E6-E4A8C30D588F";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 176.65203467539044 148.12988608036363 193.81921674330752 ;
	setAttr ".r" -type "double3" -17.738352731357995 57.800000000021797 -2.9843275299455025e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "AB212CA5-47F3-37A5-0A4C-158781D7507B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 244.45624547070327;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 20 0 69 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "178F30D4-4BEE-9432-EACB-6E89CB6EB16C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C391AB21-4FE7-F025-23A6-C3944A37378F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "41EED56B-4671-469A-3FC7-C180F3407FE1";
createNode displayLayerManager -n "layerManager";
	rename -uid "A946B4FF-4B25-8C98-305C-86A8370FF897";
createNode displayLayer -n "defaultLayer";
	rename -uid "072D0700-4D6A-442B-4D8D-35947BED09E6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BBDC9F2B-483D-4C82-53EB-FAA9157C650C";
...
createNode decomposeMatrix -n "DCM_10";
	rename -uid "605FA722-49E9-503B-FE5D-3B9C6A0E6F77";
createNode decomposeMatrix -n "DCM_11";
	rename -uid "BB268D20-446D-A086-7B3A-9A88F1EF234B";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
...
select -ne :hyperGraphLayout;
	setAttr -k on ".nds";
	setAttr -s 14 ".hyp";
	setAttr ".hyp[84949].isc" yes;
	setAttr ".hyp[84950].isc" yes;
	setAttr ".hyp[84953].isc" yes;
	setAttr ".hyp[84954].isc" yes;
	setAttr ".hyp[84955].isc" yes;
	setAttr ".hyp[84956].isc" yes;
	setAttr ".hyp[84957].isc" yes;
	setAttr ".hyp[84958].isc" yes;
	setAttr ".hyp[84959].isc" yes;
	setAttr ".hyp[84960].isc" yes;
	setAttr ".hyp[84961].isc" yes;
...
connectAttr "hip_guide_line1.msg" ":hyperGraphLayout.hyp[84949].dn";
connectAttr "line_grp.msg" ":hyperGraphLayout.hyp[84950].dn";
connectAttr "palm_heelPos_guide.msg" ":hyperGraphLayout.hyp[84953].dn";
connectAttr "palm_inPos_guide.msg" ":hyperGraphLayout.hyp[84954].dn";
connectAttr "palm_outPos_guide.msg" ":hyperGraphLayout.hyp[84955].dn";
connectAttr "hip_guide_ofs.msg" ":hyperGraphLayout.hyp[84956].dn";
connectAttr "upr_guide_ofs.msg" ":hyperGraphLayout.hyp[84957].dn";
connectAttr "plane_guide_ofs.msg" ":hyperGraphLayout.hyp[84958].dn";
connectAttr "fetlock_guide_ofs.msg" ":hyperGraphLayout.hyp[84959].dn";
connectAttr "pastern_guide_ofs.msg" ":hyperGraphLayout.hyp[84960].dn";
connectAttr "pasternTip_guide_ofs.msg" ":hyperGraphLayout.hyp[84961].dn";
connectAttr "pv_loc_ofs.msg" ":hyperGraphLayout.hyp[84962].dn";
connectAttr "plane_guide_line1.msg" ":hyperGraphLayout.hyp[84963].dn";
connectAttr "palm_toePos_guide.msg" ":hyperGraphLayout.hyp[84964].dn";
// End of lfQFLeg.ma
