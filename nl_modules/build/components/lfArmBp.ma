...
//Name: lfArmBp.ma
//Last modified: Thu, Apr 16, 2026 09:46:32 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "46862519-42F2-A6C7-3F9D-9DAA885DC054";
createNode transform -s -n "persp";
	rename -uid "AB7E52E5-4BC6-549B-1229-4BA904DD5D93";
	setAttr ".t" -type "double3" 96.060065501307093 191.17904702734103 61.196141089364019 ;
	setAttr ".r" -type "double3" -27.338352727070355 41.800000000004474 2.1332374770058323e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "19F6DB4F-4918-877A-57DD-5EBBE38E71A5";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 109.73926685203918;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" 9.3970406179941293 151.70129636380443 1011.6138262966883 ;
...
createNode transform -n "master_guide";
	...
	addAttr -ci true -sn "____________" -ln "____________" -min 0 -max 0 -en "____________" -at "enum";
...
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "D9067976-4C4D-59C0-5EB6-28BA8F2F05A3";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 22;
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		4.2085700572892695e-16 9.729978599130451 -9.729978599130451
		3.6444367292009981e-32 9.7200545616249237 -5.9518168532157938e-16
		-4.2085700572892695e-16 9.729978599130451 9.729978599130451
		-5.9518168532157967e-16 5.0388934490764678e-16 9.7200545616249272
		-4.2085700572892695e-16 -9.729978599130451 9.729978599130451
		-5.9619756482056013e-32 -9.7200545616249308 9.7366451328767851e-16
		4.2085700572892695e-16 -9.729978599130451 -9.729978599130451
		5.9518168532157967e-16 -1.3255204086330459e-15 -9.7200545616249272
		4.2085700572892695e-16 9.729978599130451 -9.729978599130451
		3.6444367292009981e-32 9.7200545616249237 -5.9518168532157938e-16
		-4.2085700572892695e-16 9.729978599130451 9.729978599130451
		;
...
createNode nurbsCurve -n "line_04Shape" -p "line_04";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2
		66 140 0
		73.5 140 2.8421709430404007e-14
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_06Shape" -p "line_06";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		39 144 4.5347577102849397e-16
		66 140 3.9999999999999991
		;
	setAttr ".adot" yes;
...
createNode nurbsCurve -n "line_07Shape" -p "line_07";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		39 136 4.6311515269305498e-16
		66 140 -4.0000000000000009
		;
	setAttr ".adot" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B90F0818-4BA3-602D-42EF-80BB9B8D4320";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9BA578E1-4652-C1EF-4E83-99AF3599F465";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5B72B344-44F8-C579-F454-83B617327E2D";
createNode displayLayerManager -n "layerManager";
	rename -uid "A7F94697-4B2B-923E-0A3A-8BB4CF4CE456";
createNode displayLayer -n "defaultLayer";
	rename -uid "4011EB8B-4296-1EB2-2E08-40844F6318E5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "758DB540-4FEE-AA9A-42FD-E481836226A0";
