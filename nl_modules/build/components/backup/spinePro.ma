...
//Name: spinePro.ma
//Last modified: Fri, Jun 21, 2024 05:05:20 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "3E52CA13-476B-D61A-EE28-16964499BF51";
createNode transform -s -n "persp";
	rename -uid "BEF4D478-470D-B96E-7F25-D6BB1F00F95C";
	setAttr ".t" -type "double3" 111.9566698998559 108.93810336227924 145.83313156102116 ;
	setAttr ".r" -type "double3" -27.938352730743816 33.799999999994121 3.8274538202149232e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CCC4238E-49DB-012B-6DB1-389ECA0FD5CF";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 153.19247263750236;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.0026507540605962276 124.39484405517578 4.7983694076538086 ;
...
createNode nurbsCurve -n "line_1Shape" -p "line_1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		3.8014230762085065e-06 53 -2.6645352591003757e-15
		;
createNode transform -n "master_guide" -p "module_grp";
	...
	addAttr -ci true -sn "bindJntNum" -ln "bindJntNum" -dv 5 -min 3 -at "long";
	setAttr -cb on ".ro";
...
createNode transform -n "ed_guide_ofs" -p "st_guide";
	...
	setAttr ".t" -type "double3" 3.8014230762085065e-06 53 -8.8817841970012523e-16 ;
...
createNode locator -n "ed_guideShape" -p "ed_guide";
	rename -uid "5D388CC9-4566-DC48-5D4C-F5992792C4D7";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
	setAttr ".los" -type "double3" 3 3 3 ;
createNode locator -n "st_guideShape" -p "st_guide";
	rename -uid "2E20AA17-4E30-49E3-0601-52AE253A3DF7";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
	setAttr ".los" -type "double3" 3 3 3 ;
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		33.696737860517324 1.6442286584276262e-15 -33.696737860517331
		2.2419525213514919e-15 2.2419525213514919e-15 -36.613863244691018
		-33.696737860517324 1.6442286584276262e-15 -33.696737860517324
		-36.613863244691068 1.1622321460600894e-31 -2.2116161269064616e-14
		-33.696737860517324 -1.6442286584276262e-15 33.696737860517302
		-3.6676357225883818e-15 -2.2419525213514927e-15 36.613863244691068
		33.696737860517324 -1.6442286584276262e-15 33.696737860517302
		36.613863244691068 -3.0573427375297789e-31 -1.522507252980087e-14
		33.696737860517324 1.6442286584276262e-15 -33.696737860517331
		2.2419525213514919e-15 2.2419525213514919e-15 -36.613863244691018
		-33.696737860517324 1.6442286584276262e-15 -33.696737860517324
		;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4CCF246D-4B8C-47DD-41F5-C1A3964DBB3C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "31A1D971-4A57-6532-92CE-2AA76CE01352";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E330E4A3-43E2-6E8A-3E3E-F58FB0AEBCAF";
createNode displayLayerManager -n "layerManager";
	rename -uid "19DB13FC-4B09-B69B-42FB-4EBE5EFE2DB5";
createNode displayLayer -n "defaultLayer";
	rename -uid "030144B0-43CD-0617-1B9C-988179186839";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6843A37D-41A7-6F2A-3F44-80A547E52F93";
...
createNode script -n "RGN";
	...
	setAttr ".rigClass" -type "string" "SpinePro";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "450334D3-4F0E-AA1F-A0C7-2CB79D957EFC";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 42085.712613378317 -872.60372242501353 ;
	setAttr ".tgi[0].vh" -type "double2" 43086.903049785054 148.79422737709478 ;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "3378B168-4FB4-0898-D09B-24AE7C4B58E8";
	setAttr ".version" -type "string" "5.2.1.1";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "5915E4C7-43E9-C8F2-14D9-26B494F497EB";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "73AC8355-4753-F9DD-2C3A-91BD03C57CD3";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "A8168A3A-4ADC-D0D6-0BD5-F38908D86694";
