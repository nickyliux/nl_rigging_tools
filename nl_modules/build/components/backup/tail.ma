...
//Name: tail.ma
//Last modified: Fri, Jun 21, 2024 05:17:22 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "DD883B03-4A53-0035-6103-16A20F362346";
createNode transform -s -n "persp";
	rename -uid "BEF4D478-470D-B96E-7F25-D6BB1F00F95C";
	setAttr ".t" -type "double3" 151.65965468144262 70.609916035611803 91.688267759685715 ;
	setAttr ".r" -type "double3" -21.938352730743564 55.399999999994499 -2.8005544739826697e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CCC4238E-49DB-012B-6DB1-389ECA0FD5CF";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 200.58479371438608;
...
createNode transform -n "line_1" -p "line_grp";
	rename -uid "3B92E0E7-4277-EA1E-710A-92A4709A0230";
createNode nurbsCurve -n "line_1Shape" -p "line_1";
	rename -uid "E056FEEF-4B87-001A-F0B0-6B8D2C7DD8FC";
	setAttr -k off ".v";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
	setAttr -s 2 ".cp";
...
createNode transform -n "master_guide" -p "module_grp";
	...
	addAttr -ci true -sn "__________" -ln "__________" -min 0 -max 0 -en "__________" 
		-at "enum";
	addAttr -ci true -sn "ctlNum" -ln "ctlNum" -dv 1 -min 1 -at "long";
	addAttr -ci true -sn "jntPerCtl" -ln "jntPerCtl" -dv 2 -min 2 -at "long";
	setAttr -cb on ".ro";
	setAttr -l on -k on ".__________";
	setAttr -cb on ".ctlNum" 4;
	setAttr -cb on ".jntPerCtl";
createNode nurbsCurve -n "master_guideShape" -p "master_guide";
	rename -uid "0322A04F-4652-493A-C291-639430CA12A6";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 25;
	setAttr ".ls" 2;
	setAttr ".cc" -type "nurbsCurve" 
		...
		5 0 1 2 3 4
		5
		19.912834581063436 -19.864244622585272 8.8817841970012523e-16
		-19.912834581063436 -19.864244622585272 8.8817841970012523e-16
		-19.912834581063436 19.864244622585272 -8.8817841970012523e-16
		19.912834581063436 19.864244622585272 -8.8817841970012523e-16
		19.912834581063436 -19.864244622585272 8.8817841970012523e-16
...
createNode locator -n "st_guideShape" -p "st_guide";
	rename -uid "29191A06-45A4-7B33-6C00-FAADA1C825AD";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
	setAttr ".los" -type "double3" 2 2 2 ;
createNode transform -n "ed_guide_ofs" -p "master_guide";
	rename -uid "F7DC2121-45E4-27D1-426C-909BB85A8C50";
createNode transform -n "ed_guide" -p "ed_guide_ofs";
	rename -uid "B22F3DEE-4DD5-2D58-7E43-04AA7ECD9F21";
	setAttr -l on ".v";
	setAttr ".ovc" 1;
...
createNode locator -n "ed_guideShape" -p "ed_guide";
	rename -uid "17641F77-4AA7-2432-CEA3-2F8C22C5C183";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
	setAttr ".los" -type "double3" 2 2 2 ;
createNode transform -n "group";
	rename -uid "BD7900FA-40C7-F82E-923D-05AB8335E391";
	setAttr ".t" -type "double3" 15.912382528236849 0 0 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A901A8E5-41FA-1D24-21BA-86B0442FF793";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3180D197-436F-3DC1-B4C4-8C8773132C13";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6E859463-4C65-54DC-51F7-E897F5BDE6AE";
createNode displayLayerManager -n "layerManager";
	rename -uid "A39A08A7-464C-EF4B-2CB5-039CD12EB3D5";
createNode displayLayer -n "defaultLayer";
	rename -uid "030144B0-43CD-0617-1B9C-988179186839";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5D8C1280-4A74-C0A6-12C5-F1828FE9C565";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "DB5F4B26-4E7A-A1FA-9355-EC89DD0AC9C0";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 80073.970879315471 -1680.5458101084503 ;
	setAttr ".tgi[0].vh" -type "double2" 82874.048197396114 956.73631506053118 ;
createNode decomposeMatrix -n "DCM_1";
	rename -uid "A6799B0D-45BF-ED35-95B1-82B4070960EC";
createNode decomposeMatrix -n "DCM_2";
	rename -uid "BBD91DAB-465B-102B-F7C0-D5993BE4783B";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "09AFA269-4FAF-15F4-B87A-0D885899507D";
	setAttr ".version" -type "string" "5.2.1.1";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "5B92AC36-4ECD-0358-F2E1-7B8F25F813E7";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "3E06DC8E-45E0-81CF-07C9-B98F82E744C4";
	setAttr ".ai_translator" -type "string" "exr";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "C1E30827-47B3-6D5F-F81F-149112D420F2";
...
connectAttr "ed_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
connectAttr "st_guide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[7].dn";
connectAttr "master_guideShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
