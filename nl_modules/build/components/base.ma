...
//Name: base.ma
//Last modified: Wed, Oct 29, 2025 03:25:21 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "7C8B2C1B-463A-30A1-75F3-BA9FCACAEF7B";
...
createNode nurbsCurve -n "master2_ctlShape" -p "master2_ctl";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		-20.455300258268643 -9.3118653659852538e-15 142
		5.8736840713227621e-14 -9.4076213870353773e-15 142
		20.455300258268707 -9.3118653659852538e-15 142
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 156.19518817706694 266.75054980933191 254.91071908331855 ;
	setAttr ".r" -type "double3" -45.938352730302945 33.80000000000269 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 394.90702618851026;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E1E67528-4DB9-EF19-C8DC-57A42ECAAB7C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "02EA4113-4822-DBCE-6398-6196AAF7E0F4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C33B54E1-4DFE-D4B5-39F3-45A7CF29D01D";
createNode displayLayerManager -n "layerManager";
	rename -uid "89115CCC-4662-95A7-54D5-18B0B6FE3FE2";
createNode displayLayer -n "defaultLayer";
	rename -uid "0EA9D9AE-4D1D-D355-DC25-0CBA922977DB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C8B387F0-4564-A105-BC1C-29AF42FDECDD";
