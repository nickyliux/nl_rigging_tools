...
//Name: base.ma
//Last modified: Sat, May 31, 2025 12:31:23 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "CF2B97B8-48D4-958F-3D10-699EE0F32256";
...
createNode nurbsCurve -n "master2_ctlShape" -p "master2_ctl";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		143.73273023708612 -3.1379745818033964e-31 2.073812098666967e-14
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -510.92980294596504 405.01420576074679 412.95895662262632 ;
	setAttr ".r" -type "double3" -32.138352730299111 -52.599999999997344 2.6182755992667968e-15 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B23FF5E1-47DF-4BA5-D7AE-8F89869300CB";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "77D12CF5-4E55-A43C-642A-B5BD057D2D86";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ED345E09-4E35-04AF-6F45-078541D9453F";
createNode displayLayerManager -n "layerManager";
	rename -uid "58BAF9A4-4035-C8CD-FAC3-BB82E38E0D80";
createNode displayLayer -n "defaultLayer";
	rename -uid "0EA9D9AE-4D1D-D355-DC25-0CBA922977DB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7DF63CA2-4CA1-634D-3395-C29E9B54EBD2";
