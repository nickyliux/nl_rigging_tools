...
//Name: lfArmQd.ma
//Last modified: Tue, May 27, 2025 03:30:39 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "9D9FDC51-4D21-F629-5C0B-B594DF86F67A";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 234.22537269289219 84.982445920078561 248.93020042457383 ;
	setAttr ".r" -type "double3" -12.938352728906967 -311.39999999996866 0 ;
	setAttr -cb on ".ro";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 311.15091969084523;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E38F5BB0-4820-9424-0977-EEA064FCC578";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1340D49E-4AEE-A78F-1425-CF8DCD769BCD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "004C63FC-4873-19AB-6149-19832A66AE60";
createNode displayLayerManager -n "layerManager";
	rename -uid "28D46F70-4E46-A441-27FA-0AAC82D052DD";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "86795005-4256-2433-5D39-129BEDB04506";
