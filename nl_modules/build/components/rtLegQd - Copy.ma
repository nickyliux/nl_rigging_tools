...
//Name: rtLegQd.ma
//Last modified: Thu, Jul 17, 2025 12:15:16 AM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "35C65276-474F-249B-838B-E0AE918845AE";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 78.618777545458002 68.144132875863406 44.389966099104413 ;
	setAttr ".r" -type "double3" -9.3383527289465302 49.400000000052628 -1.2218349302580087e-15 ;
	setAttr -cb on ".ro";
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82C3F9B2-4980-6719-29B8-159665D78FA8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 103.7142263598778;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4DDE7737-4E61-0ECC-20FA-50A625085F2B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BB0D4A92-4224-A0F4-BFCA-719DE5001ECD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3A469683-46C4-FA7E-29E8-C18D46D5E60E";
createNode displayLayerManager -n "layerManager";
	rename -uid "6E69CBD6-4445-3E73-D189-7DB46B7068A8";
createNode displayLayer -n "defaultLayer";
	rename -uid "BC19330E-4E8B-4910-BB8A-238FB66CBBA1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "104D6B88-4B8C-1B0B-E946-CBBE2FC44809";
