...
class SpineQd(RigModule):
    ...
    def setup_vis(self):
        ...
        self.ctl_vis_toggle(
            self.setting.a.add("showFk", type="bool", k=0),
            onList=self.ctls_fk,
            shape=1,
        )
        self.ctl_vis_toggle(
            self.setting.a.add("showIk", type="bool", k=0, dv=1),
            onList=self.ctls_ik,
            shape=1,
        )
    ...
    def setup_ctlSets(self):
        ...
        ctls = self.ctls_fk + self.ctls_ik + [self.cog_ctl, self.setting, self.end_ctl]
